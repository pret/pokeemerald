...
Move_POISON_POWDER:
	...
	loopsewithpan SE_W077, SOUND_PAN_TARGET, 0xA, 0x6
...
Move_TWINEEDLE:
	...
	monbgprio_28 ANIM_TARGET
	setalpha 0x80C
	loopsewithpan SE_W013B, SOUND_PAN_ATTACKER, 0x6, 0x2
	...
	loopsewithpan SE_W030, SOUND_PAN_TARGET, 0x5, 0x2
	delay 0x1
...
Move_LEECH_SEED:
	...
	delay 0xC
	loopsewithpan SE_W039, SOUND_PAN_TARGET, 0xA, 0x8
	waitforvisualfinish
	end

Move_EMBER:
	loadspritegfx 0x272D
	loopsewithpan SE_W052, SOUND_PAN_ATTACKER, 0x5, 0x2
...
Move_TAIL_WHIP:
	loopsewithpan SE_W039, SOUND_PAN_ATTACKER, 0x18, 0x3
...
Move_SPIKE_CANNON:
	...
	waitforvisualfinish
	loopsewithpan SE_W013B, SOUND_PAN_ATTACKER, 0x5, 0x3
	createsprite gUnknown_0857FE58, 0x2, 0, 0, 5
	...
	loopsewithpan SE_W030, SOUND_PAN_TARGET, 0x5, 0x3
	waitforvisualfinish
	clearmonbg ANIM_TARGET
	blendoff
	end
...
Move_PSYCH_UP:
	...
	setalpha 0x80C
	loopsewithpan SE_W060B, SOUND_PAN_ATTACKER, 0x5, 0xA
...
Move_OUTRAGE:
	loadspritegfx 0x272D
	loopsewithpan SE_W082, SOUND_PAN_ATTACKER, 0x8, 0x3
...
Move_WHIRLWIND:
	...
	delay 0x5
	loopsewithpan SE_W104, SOUND_PAN_TARGET, 0xA, 0x4
...
Move_MEAN_LOOK:
	...
	loopsewithpan SE_W109, SOUND_PAN_TARGET, 0xF, 0x4
...
Move_ICY_WIND:
	...
	waitbgfadein
	waitforvisualfinish
	panse_1B SE_W016, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
...
Move_SING:
	...
	waitforvisualfinish
	panse_1B SE_W047, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
...
Move_MINIMIZE:
	...
	loopsewithpan SE_W107, SOUND_PAN_ATTACKER, 0x22, 0x3
	waitforvisualfinish
	blendoff
	end
...
AnimScript_82CCFE6:
	...
	loopsewithpan SE_W025B, SOUND_PAN_TARGET, 0x8, 0x3
	waitforvisualfinish
...
Move_AMNESIA:
	...
	playsewithpan SE_W118, SOUND_PAN_ATTACKER
	delay 0x36
	loopsewithpan SE_W118, SOUND_PAN_ATTACKER, 0x10, 0x3
	waitforvisualfinish
	call AnimScript_82D7CDD
	end
...
Move_KINESIS:
	...
	loopsewithpan SE_W109, SOUND_PAN_ATTACKER, 0x15, 0x2
	delay 0x3C
	playsewithpan SE_W146, SOUND_PAN_ATTACKER
	delay 0x1E
	loopsewithpan SE_W146, SOUND_PAN_ATTACKER, 0x14, 0x2
	delay 0x46
	playsewithpan SE_W207B, SOUND_PAN_ATTACKER
	waitforvisualfinish
	call AnimScript_82D7CDD
...
Move_BARRAGE:
	...
	loopsewithpan SE_W070, SOUND_PAN_TARGET, 0x8, 0x2
	end
...
AnimScript_82CD1A0:
	...
	loopsewithpan SE_W287, SOUND_PAN_ATTACKER, 0x4, 0x8
...
Move_SPLASH:
	...
	delay 0x8
	loopsewithpan SE_W039, SOUND_PAN_ATTACKER, 0x26, 0x3
	waitforvisualfinish
	end
...
Move_STRUGGLE:
	...
	loopsewithpan SE_W029, SOUND_PAN_ATTACKER, 0xC, 0x4
	waitforvisualfinish
	createsprite gUnknown_08597358, 0x3, 0, 0, 1, 2
...
Move_SKETCH:
	...
	loopsewithpan SE_W039, SOUND_PAN_ATTACKER, 0x26, 0x2
	end
...
Move_SPITE:
	...
	loopsewithpan SE_W060, SOUND_PAN_TARGET, 0x14, 0x3
	waitforvisualfinish
	restorebg
	waitbgfadein
	clearmonbg ANIM_TARGET
...
Move_FORESIGHT:
	...
	delay 0x11
	loopsewithpan SE_W166, SOUND_PAN_TARGET, 0x10, 0x4
	delay 0x30
	delay 0x18
...
Move_SWAGGER:
	...
	loopsewithpan SE_W207, SOUND_PAN_ATTACKER, 0x4, 0x2
	waitforvisualfinish
	delay 0x18
...
AnimScript_82CD8C9:
	...
	loopsewithpan SE_W070, SOUND_PAN_TARGET, 0x8, 0xA
...
Move_RAPID_SPIN:
	...
	loopsewithpan SE_W013B, SOUND_PAN_ATTACKER, 0x8, 0x4
	waitforvisualfinish
	createsprite gUnknown_08597358, 0x82, 0, 0, 1, 2
...
AnimScript_82CDA55:
	...
	loopsewithpan SE_W013B, SOUND_PAN_ATTACKER, 0x8, 0x3
	waitforvisualfinish
	delay 0x1
	...
	loopsewithpan SE_W104, SOUND_PAN_ATTACKER, 0x8, 0x4
	waitforvisualfinish
	restorebg
	waitbgfadeout
	setarg 0x7, 0xFFFF
...
Move_HEAT_WAVE:
	...
	panse_1B SE_W257, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
	delay 0x4
...
Move_FACADE:
	...
	loopsewithpan SE_W207, SOUND_PAN_ATTACKER, 0x18, 0x3
	end
...
Move_SMELLING_SALT:
	...
	loopsewithpan SE_W003, SOUND_PAN_TARGET, 0xC, 0x2
	waitforvisualfinish
	delay 0x4
	createvisualtask sub_80D52D0, 0x2, 1, 2, 0, 6, 2
	createsprite gUnknown_085CE894, 0x82, 1, 8, 3
	loopsewithpan SE_W207B, SOUND_PAN_TARGET, 0x10, 0x3
	end
...
Move_CHARGE:
	...
	delay 0xA
	delay 0x6
	loopsewithpan SE_W268, SOUND_PAN_ATTACKER, 0x6, 0x5
	waitforvisualfinish
...
Move_TAUNT:
	...
	delay 0x4
	loopsewithpan SE_W039, SOUND_PAN_ATTACKER, 0x10, 0x2
	waitforvisualfinish
	delay 0x8
	createsprite gUnknown_0859368C, 0x82, 1, -20, -28
	playsewithpan SE_W207B, SOUND_PAN_TARGET
...
Move_RECYCLE:
	...
	loopsewithpan SE_W036, SOUND_PAN_ATTACKER, 0x18, 0x3
	waitforvisualfinish
...
Move_ENDEAVOR:
	...
	loopsewithpan SE_W039, SOUND_PAN_ATTACKER, 0x18, 0x2
...
Move_ERUPTION:
	...
	waitplaysewithpan SE_W153, SOUND_PAN_ATTACKER, 0x3C
	waitforvisualfinish
	createvisualtask sub_8109460, 0x2
	waitplaysewithpan SE_W153, SOUND_PAN_ATTACKER, 0x3C
	waitforvisualfinish
	...
	loopsewithpan SE_W088, SOUND_PAN_TARGET, 0x10, 0xC
	delay 0x50
...
Move_SKILL_SWAP:
	...
	loopsewithpan SE_W179, SOUND_PAN_ATTACKER, 0x18, 0x3
	delay 0x10
...
Move_IMPRISON:
	...
	delay 0x8
	loopsewithpan SE_W030, SOUND_PAN_ATTACKER, 0x8, 0x5
	waitforvisualfinish
	delay 0x4
...
Move_GRUDGE:
	...
	loopsewithpan SE_W052, SOUND_PAN_ATTACKER, 0x10, 0x4
	delay 0xA
	delay 0x50
	playsewithpan SE_W171, SOUND_PAN_TARGET
	waitforvisualfinish
...
Move_TAIL_GLOW:
	...
	delay 0x12
	loopsewithpan SE_W234, SOUND_PAN_ATTACKER, 0x10, 0x6
	waitforvisualfinish
	createsprite gUnknown_08597274, 0x2, 1, 4, 4, 0, RGB_BLACK
	clearmonbg ANIM_ATTACKER
	blendoff
...
Move_NEEDLE_ARM:
	...
	loadspritegfx 0x2797
	loadspritegfx 0x279F
	loopsewithpan SE_W030, SOUND_PAN_TARGET, 0x2, 0x10
...
Move_FAKE_TEARS:
	...
	loopsewithpan SE_W039, SOUND_PAN_ATTACKER, 0xC, 0x4
	delay 0x8
...
Move_GRASS_WHISTLE:
	...
	createvisualtask sub_8102BE8, 0x2
	waitforvisualfinish
	panse_1B SE_W320, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
...
Move_TICKLE:
	...
	loopsewithpan SE_W039, SOUND_PAN_TARGET, 0x8, 0x8
	waitforvisualfinish
	end
...
Move_COVET:
	...
	waitforvisualfinish
	createvisualtask sub_80D52D0, 0x2, 1, 2, 0, 8, 1
	loopsewithpan SE_W146, SOUND_PAN_TARGET, 0x4, 0x3
	end
...
Move_WATER_SPORT:
	...
	playsewithpan SE_W057, SOUND_PAN_ATTACKER
	delay 0x2C
	panse_1B SE_W057, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
	end
...
Move_SACRED_FIRE:
	...
	loopsewithpan SE_W221, SOUND_PAN_ATTACKER, 0x7, 0x5
...
Move_DRAGON_BREATH:
	...
	monbg ANIM_DEF_PARTNER
	monbgprio_28 ANIM_TARGET
	loopsewithpan SE_W172, SOUND_PAN_ATTACKER, 0x7, 0x7
...
Move_LIGHT_SCREEN:
	...
	setalpha 0x1000
	waitplaysewithpan SE_W115, SOUND_PAN_ATTACKER, 0xF
...
Move_BARRIER:
	...
	setalpha 0x1000
	waitplaysewithpan SE_W112, SOUND_PAN_ATTACKER, 0xF
...
Move_BUBBLE:
	...
	playsewithpan SE_W145, SOUND_PAN_ATTACKER
	waitplaysewithpan SE_W145B, SOUND_PAN_TARGET, 0x64
	delay 0x6
...
Move_SMOG:
	...
	monbgprio_29
	setalpha 0x80C
	loopsewithpan SE_W054, SOUND_PAN_TARGET, 0x11, 0xA
	...
	call AnimScript_82D024A
	delay 0x78
	loopsewithpan SE_W092, SOUND_PAN_TARGET, 0x12, 0x2
...
Move_DRAGON_RAGE:
	...
	waitforvisualfinish
	loopsewithpan SE_W172B, SOUND_PAN_TARGET, 0xB, 0x3
...
AnimScript_82D09E3:
	...
	panse_1B SE_W076, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
...
AnimScript_82D0B43:
	...
	waitbgfadein
	waitforvisualfinish
	panse_1B SE_W059, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
...
Move_HYDRO_PUMP:
	...
	createvisualtask sub_80D51AC, 0x5, 0, 0, 2, 40, 1
	delay 0x6
	panse_1B SE_W056, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
...
Move_SIGNAL_BEAM:
	...
	delay 0x6
	panse_1B SE_W062, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +1, 0x0
	createvisualtask sub_81076C8, 0x5, 100
...
Move_SPIKES:
	...
	monbg ANIM_DEF_PARTNER
	playsewithpan SE_W026, SOUND_PAN_ATTACKER
	waitplaysewithpan SE_W030, SOUND_PAN_TARGET, 0x1C
...
Move_WING_ATTACK:
	...
	createsprite gUnknown_08597358, 0x2, -16, 0, 1, 1
	loopsewithpan SE_W003, SOUND_PAN_TARGET, 0x5, 0x2
	waitforvisualfinish
	createsprite gUnknown_0857FE58, 0x2, 0, 0, 11
	waitforvisualfinish
	clearmonbg ANIM_DEF_PARTNER
...
Move_CRABHAMMER:
	...
	waitforvisualfinish
	loopsewithpan SE_W152, SOUND_PAN_TARGET, 0x14, 0x3
...
Move_FLAMETHROWER:
	...
	delay 0x6
	createvisualtask sub_81076C8, 0x5, 100
	panse_1B SE_W053, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
...
Move_SPORE:
	...
	loopsewithpan SE_W077, SOUND_PAN_TARGET, 0x10, 0xB
...
Move_RAZOR_LEAF:
	...
	setalpha 0x80C
	delay 0x1
	loopsewithpan SE_W077, SOUND_PAN_ATTACKER, 0xA, 0x5
...
Move_POISON_GAS:
	...
	createsprite gUnknown_08595C9C, 0x80, 64, 0, 0, -32, -6, 4192, 1072, 0
	delay 0x28
	loopsewithpan SE_W054, SOUND_PAN_TARGET, 0x1C, 0x6
...
Move_DISABLE:
	...
	loopsewithpan SE_W020, SOUND_PAN_TARGET, 0xF, 0x4
	waitforvisualfinish
	delay 0x1
	clearmonbg ANIM_TARGET
	blendoff
...
Move_RECOVER:
	...
	monbg ANIM_ATK_PARTNER
	setalpha 0x80C
	loopsewithpan SE_W025, SOUND_PAN_ATTACKER, 0xD, 0x3
...
Move_MIMIC:
	...
	monbgprio_29
	panse_1B SE_W107, SOUND_PAN_TARGET, SOUND_PAN_ATTACKER, -3, 0x0
...
Move_PERISH_SONG:
	...
	delay 0x14
	panse_1B SE_W195, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
	delay 0x50
...
Move_WILL_O_WISP:
	...
	waitplaysewithpan SE_W052, SOUND_PAN_ATTACKER, 0xA
...
Move_WISH:
	...
	waitforvisualfinish
	panse_27 SE_W115, SOUND_PAN_TARGET, SOUND_PAN_ATTACKER, -3, 0x0
...
Move_TRANSFORM:
	monbg ANIM_ATTACKER
	playsewithpan SE_W100, SOUND_PAN_ATTACKER
	waitplaysewithpan SE_W107, SOUND_PAN_ATTACKER, 0x30
...
Move_ROLE_PLAY:
	...
	waitforvisualfinish
	playsewithpan SE_W161, SOUND_PAN_ATTACKER
	waitplaysewithpan SE_W197, SOUND_PAN_ATTACKER, 0x1E
...
Move_SHEER_COLD:
	...
	waitplaysewithpan SE_W258, SOUND_PAN_TARGET, 0x11
	waitforvisualfinish
	clearmonbg ANIM_DEF_PARTNER
	blendoff
	restorebg
...
Move_MUDDY_WATER:
	panse_1B SE_W250, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
...
Move_MUD_SHOT:
	...
	delay 0x6
	createvisualtask sub_81076C8, 0x5, 100
	panse_1B SE_W250, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +1, 0x0
...
Move_METEOR_MASH:
	...
	loadspritegfx 0x2797
	loadspritegfx 0x279F
	panse_1B SE_W112, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +3, 0x0
	fadetobg BG_COSMIC
	waitbgfadein
	waitforvisualfinish
...
AnimScript_82D59EA:
	panse_1B SE_W103, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0x0
...
Move_PSYCHO_BOOST:
	...
	delay 0x6E
	loopsewithpan SE_W060B, SOUND_PAN_ATTACKER, 0x7, 0xA
	waitforvisualfinish
...
AnimScript_82D7874:
	loopsewithpan SE_W196, SOUND_PAN_TARGET, 0x6, 0x4
...
AnimScript_82D7C75:
	loopsewithpan SE_W146, SOUND_PAN_TARGET, 0xD, 0x6
...
Status_Poison:
	loopsewithpan SE_W092, SOUND_PAN_TARGET, 0xD, 0x6
...
Anim_Table_4:
	...
	delay 0x0
	waitplaysewithpan SE_W026, SOUND_PAN_ATTACKER, 0x16
	createsprite gUnknown_085E5338, 0x83, -18, 12, 0, 32
	delay 0x32
	loopsewithpan SE_W039, SOUND_PAN_TARGET, 0x13, 0x2
...
AnimScript_82D7FA1:
	loadspritegfx 0x27CA
	loopsewithpan SE_W010, SOUND_PAN_TARGET, 0x6, 0x2
...
Anim_FutureSightHit:
	...
	setalpha 0x808
	playsewithpan SE_W048, SOUND_PAN_TARGET
	waitplaysewithpan SE_W048, SOUND_PAN_TARGET, 0x8
