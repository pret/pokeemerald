...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_IS_IT_QUES, EC_WORD_LOST, EC_WORD_THOSE_WERE, EC_WORD_ELLIPSIS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_WILL_BE_HERE, EC_WORD_REFRESHING, EC_WORD_NITWIT, EC_WORD_DON_T, EC_WORD_ELLIPSIS, EC_EMPTY_WORD},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_LOL, EC_WORD_LOL, EC_WORD_IS_IT_QUES, EC_WORD_PERFECT, EC_WORD_LOST, EC_EMPTY_WORD},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_ON, EC_WORD_IS, EC_WORD_LOWS, EC_WORD_OVERWHELMING, EC_EMPTY_WORD, EC_EMPTY_WORD},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_BUT, EC_WORD_WEREN_T, EC_WORD_ANOTHER, EC_WORD_TIME, EC_WORD_WIN, EC_WORD_ISN_T_IT_QUES},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_NOW, EC_WORD_PRAISE, EC_WORD_FESTIVAL, EC_WORD_ELLIPSIS, EC_WORD_WELCOME, EC_WORD_WELCOME},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_HOW, EC_WORD_QUES, EC_WORD_LOSS, EC_WORD_QUES, EC_MOVE(BIDE), EC_WORD_ELLIPSIS},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_WILL_BE_HERE, EC_WORD_PERFECT, EC_WORD_STRONG, EC_WORD_ELLIPSIS, EC_WORD_MISS, EC_WORD_WAY},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_WILL, EC_WORD_HOWEVER, EC_WORD_POKEMON, EC_WORD_LOWS, EC_WORD_SECRET, EC_WORD_ELLIPSIS},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_OK_QUES, EC_WORD_WILL, EC_WORD_SAYS, EC_WORD_PERFECT, EC_WORD_THOSE_WERE, EC_WORD_ELLIPSIS},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_AS_IF, EC_WORD_WHOM, EC_WORD_IS, EC_WORD_MUST_BE, EC_WORD_DARN, EC_WORD_IF_I_LOSE},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_AS_IF, EC_WORD_PLEASE, EC_WORD_CONCEDE, EC_WORD_INVINCIBLE, EC_WORD_BACK, EC_EMPTY_WORD},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_LOSS, EC_WORD_ELLIPSIS, EC_WORD_OFF, EC_WORD_IS, EC_WORD_WEREN_T, EC_WORD_WORD},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_NOW, EC_WORD_ARE, EC_WORD_PERFECT, EC_WORD_DOWN, EC_EMPTY_WORD, EC_EMPTY_WORD},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_HOW, EC_WORD_WILL, EC_WORD_SAYS, EC_WORD_QUES, EC_WORD_ANGRY, EC_EMPTY_WORD},
    #endif
    },
    {
    ...
    #elif ITALIAN
        .speechLost = {EC_WORD_AS_IF, EC_WORD_CHANGE, EC_WORD_CONCEDE, EC_WORD_ELLIPSIS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    #endif
    },
};
