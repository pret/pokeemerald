...
const u8 gMonFootprint_Shellos[] = INCBIN_U8("graphics/pokemon/shellosE/footprint.1bpp");
const u8 gMonFootprint_Gastrodon[] = INCBIN_U8("graphics/pokemon/gastrodonE/footprint.1bpp");
