...
const struct Tileset gTileset_PitWaterTheme =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PitWaterTheme,
    .palettes = gTilesetPalettes_PitWaterTheme,
    .metatiles = gMetatiles_PitWaterTheme,
    .metatileAttributes = gMetatileAttributes_PitWaterTheme,
    .callback = NULL,
};

const struct Tileset gTileset_PitArenaDesert =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PitArenaDesert,
    .palettes = gTilesetPalettes_PitArenaDesert,
    .metatiles = gMetatiles_PitArenaDesert,
    .metatileAttributes = gMetatileAttributes_PitArenaDesert,
    .callback = NULL,
};

const struct Tileset gTileset_PitArenaSnow =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PitArenaSnow,
    .palettes = gTilesetPalettes_PitArenaSnow,
    .metatiles = gMetatiles_PitArenaSnow,
    .metatileAttributes = gMetatileAttributes_PitArenaSnow,
    .callback = NULL,
};

const struct Tileset gTileset_PitArenaBeach =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PitArenaBeach,
    .palettes = gTilesetPalettes_PitArenaBeach,
    .metatiles = gMetatiles_PitArenaBeach,
    .metatileAttributes = gMetatileAttributes_PitArenaBeach,
    .callback = NULL,
};

const struct Tileset gTileset_PitArenaDeepForest =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PitArenaDeepForest,
    .palettes = gTilesetPalettes_PitArenaDeepForest,
    .metatiles = gMetatiles_PitArenaDeepForest,
    .metatileAttributes = gMetatileAttributes_PitArenaDeepForest,
    .callback = NULL,
};

const struct Tileset gTileset_PitArenaDirtPath =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PitArenaDirtPath,
    .palettes = gTilesetPalettes_PitArenaDirtPath,
    .metatiles = gMetatiles_PitArenaDirtPath,
