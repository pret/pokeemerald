...
static const u8 sLiberoDescription[] = _("Changes type to match move.");
static const u8 sBallFetchDescription[] = _("Fetches first failed Poké Ball.");
static const u8 sCottonDownDescription[] = _("Lowers everyone's Speed when hit.");
static const u8 sPropellerTailDescription[] = _("Moves ignore redirection.");
static const u8 sMirrorArmorDescription[] = _("Bounces back stat decreases.");
static const u8 sGulpMissileDescription[] = _("Spits prey if damaged after a swim.");
static const u8 sStalwartDescription[] = _("Moves ignore redirection.");
static const u8 sSteamEngineDescription[] = _("Fire and Water hits boost Speed.");
static const u8 sPunkRockDescription[] = _("Ups and resists sound moves.");
static const u8 sSandSpitDescription[] = _("Creates a sandstorm when hit.");
static const u8 sIceScalesDescription[] = _("Halves special damage.");
static const u8 sRipenDescription[] = _("Doubles Berry effects.");
static const u8 sIceFaceDescription[] = _("Takes one free physical hit.");
static const u8 sPowerSpotDescription[] = _("Powers up ally moves.");
static const u8 sMimicryDescription[] = _("Changes type with terrain.");
static const u8 sScreenCleanerDescription[] = _("Screens are removed on entry.");
static const u8 sSteelySpiritDescription[] = _("Boosts ally Steel moves.");
static const u8 sPerishBodyDescription[] = _("Gives a perish count on contact.");
static const u8 sWanderingSpiritDescription[] = _("Trades Abilities on contact.");
static const u8 sGorillaTacticsDescription[] = _("Ups Attack, but allows one move.");
