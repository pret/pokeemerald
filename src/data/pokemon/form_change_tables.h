...
static const struct FormChange sDeoxysFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_DEOXYS, ITEM_FORM_CHANGER},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEOXYS_ATTACK, ITEM_X_ATTACK},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEOXYS_DEFENSE, ITEM_X_DEFENSE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEOXYS_SPEED, ITEM_X_SPEED},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sRotomFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_ROTOM, ITEM_FORM_CHANGER},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ROTOM_HEAT, ITEM_CHARCOAL},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ROTOM_WASH, ITEM_MYSTIC_WATER},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ROTOM_FROST, ITEM_NEVER_MELT_ICE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ROTOM_FAN, ITEM_SHARP_BEAK},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ROTOM_MOW, ITEM_MIRACLE_SEED},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sNecrozmaFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_NECROZMA, ITEM_FORM_CHANGER},
    {FORM_CHANGE_ITEM_USE, SPECIES_NECROZMA_DUSK_MANE, ITEM_N_SOLARIZER},
    {FORM_CHANGE_ITEM_USE, SPECIES_NECROZMA_DAWN_WINGS, ITEM_N_LUNARIZER},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_NECROZMA_ULTRA, ITEM_ULTRANECROZIUM_Z},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sKyuremFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_KYUREM, ITEM_FORM_CHANGER},
    {FORM_CHANGE_ITEM_USE, SPECIES_KYUREM_WHITE, ITEM_DNA_SPLICERS},
    {FORM_CHANGE_ITEM_USE, SPECIES_KYUREM_BLACK, ITEM_DNA_SPLICERS},
    {FORM_CHANGE_TERMINATOR},
};
#endif
...
static const struct FormChange sZygardePowerConstructFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_ZYGARDE_COMPLETE, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_FAINT},
