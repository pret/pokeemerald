...
//0.01_alpha    Changed trade evolutions into different ones that does not require trading
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_HAUNTER]    = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_GENGAR}},
    //End Change 20200928_0.01_alpha
    //Start Change 20200929_0.01_alpha
