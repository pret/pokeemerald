...
#define NINETALES_MISC_INFO                                         \
    ...
    [SPECIES_GOLBAT] =
    {
        ...
        ICON(Golbat, 2),
        FOOTPRINT(Golbat)
        FOLLOWER(Golbat, SIZE_32x32, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Golbat),
...
#define WEEZING_MISC_INFO                                           \
    ...
    [SPECIES_HAPPINY] =
    {
        ...
        ICON(Happiny, 0),
        FOOTPRINT(Happiny)
        FOLLOWER(Happiny, SIZE_32x32, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Happiny),
    ...
    [SPECIES_CHANSEY] =
    {
        ...
        ICON(Chansey, 0),
        FOOTPRINT(Chansey)
        FOLLOWER(Chansey, SIZE_32x32, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Chansey),
    ...
    [SPECIES_BLISSEY] =
    {
        ...
        ICON(Blissey, 0),
        FOOTPRINT(Blissey)
        FOLLOWER(Blissey, SIZE_32x32, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Blissey),
    },
#endif //P_GEN_2_CROSS_EVOS
...
#define EEVEE_MISC_INFO                                                                 \
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        ICON(Omanyte, 0),
        FOOTPRINT(Omanyte)
        FOLLOWER(Omanyte, SIZE_32x32, SHADOW_SIZE_M, TRACKS_SPOT)
        LEARNSETS(Omanyte),
...
#define MOLTRES_MISC_INFO                                               \
    ...
    [SPECIES_MOLTRES_GALARIAN] =
    {
        ...
        FOLLOWER(MoltresGalarian, SIZE_32x32, SHADOW_SIZE_M, TRACKS_FOOT)
