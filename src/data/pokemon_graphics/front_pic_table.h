const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(URSALUNA, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_Ursaluna),
    ...
    SPECIES_SPRITE(OVERQWIL, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_Overqwil),
    ...
    SPECIES_SPRITE(GROWLITHE_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_GrowlitheHisuian),
    SPECIES_SPRITE(ARCANINE_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_ArcanineHisuian),
    SPECIES_SPRITE(VOLTORB_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_VoltorbHisuian),
    SPECIES_SPRITE(ELECTRODE_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_ElectrodeHisuian),
    SPECIES_SPRITE(TYPHLOSION_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_TyphlosionHisuian),
    SPECIES_SPRITE(QWILFISH_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_QwilfishHisuian),
    SPECIES_SPRITE(SNEASEL_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_SneaselHisuian),
    SPECIES_SPRITE(SAMUROTT_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_SamurottHisuian),
    SPECIES_SPRITE(LILLIGANT_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_LilligantHisuian),
    SPECIES_SPRITE(ZORUA_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_ZoruaHisuian),
    SPECIES_SPRITE(ZOROARK_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_ZoroarkHisuian),
    SPECIES_SPRITE(BRAVIARY_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_BraviaryHisuian),
    SPECIES_SPRITE(SLIGGOO_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_SliggooHisuian),
    SPECIES_SPRITE(GOODRA_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_GoodraHisuian),
    SPECIES_SPRITE(AVALUGG_HISUIAN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_AvaluggHisuian),
    ...
    SPECIES_SPRITE(DIALGA_ORIGIN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_DialgaOrigin),
    SPECIES_SPRITE(PALKIA_ORIGIN, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_PalkiaOrigin),
    ...
    SPECIES_SPRITE(BASCULIN_WHITE_STRIPED, gMonFrontPic_CircledQuestionMark), //gMonFrontPic_BasculinWhiteStriped),
