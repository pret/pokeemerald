const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(VENUSAUR_MEGA, gMonFrontPic_MegaVenusaur),
    SPECIES_SPRITE(CHARIZARD_MEGA_X, gMonFrontPic_MegaCharizardX),
    SPECIES_SPRITE(CHARIZARD_MEGA_Y, gMonFrontPic_MegaCharizardY),
    SPECIES_SPRITE(BLASTOISE_MEGA, gMonFrontPic_MegaBlastoise),
    SPECIES_SPRITE(BEEDRILL_MEGA, gMonFrontPic_MegaBeedrill),
    SPECIES_SPRITE(PIDGEOT_MEGA, gMonFrontPic_MegaPidgeot),
    SPECIES_SPRITE(ALAKAZAM_MEGA, gMonFrontPic_MegaAlakazam),
    SPECIES_SPRITE(SLOWBRO_MEGA, gMonFrontPic_MegaSlowbro),
    SPECIES_SPRITE(GENGAR_MEGA, gMonFrontPic_MegaGengar),
    SPECIES_SPRITE(KANGASKHAN_MEGA, gMonFrontPic_MegaKangaskhan),
    SPECIES_SPRITE(PINSIR_MEGA, gMonFrontPic_MegaPinsir),
    SPECIES_SPRITE(GYARADOS_MEGA, gMonFrontPic_MegaGyarados),
    SPECIES_SPRITE(AERODACTYL_MEGA, gMonFrontPic_MegaAerodactyl),
    SPECIES_SPRITE(MEWTWO_MEGA_X, gMonFrontPic_MegaMewtwoX),
    SPECIES_SPRITE(MEWTWO_MEGA_Y, gMonFrontPic_MegaMewtwoY),
    SPECIES_SPRITE(AMPHAROS_MEGA, gMonFrontPic_MegaAmpharos),
    SPECIES_SPRITE(STEELIX_MEGA, gMonFrontPic_MegaSteelix),
    SPECIES_SPRITE(SCIZOR_MEGA, gMonFrontPic_MegaScizor),
    SPECIES_SPRITE(HERACROSS_MEGA, gMonFrontPic_MegaHeracross),
    SPECIES_SPRITE(HOUNDOOM_MEGA, gMonFrontPic_MegaHoundoom),
    SPECIES_SPRITE(TYRANITAR_MEGA, gMonFrontPic_MegaTyranitar),
    SPECIES_SPRITE(SCEPTILE_MEGA, gMonFrontPic_MegaSceptile),
    SPECIES_SPRITE(BLAZIKEN_MEGA, gMonFrontPic_MegaBlaziken),
    SPECIES_SPRITE(SWAMPERT_MEGA, gMonFrontPic_MegaSwampert),
    SPECIES_SPRITE(GARDEVOIR_MEGA, gMonFrontPic_MegaGardevoir),
    SPECIES_SPRITE(SABLEYE_MEGA, gMonFrontPic_MegaSableye),
    SPECIES_SPRITE(MAWILE_MEGA, gMonFrontPic_MegaMawile),
    SPECIES_SPRITE(AGGRON_MEGA, gMonFrontPic_MegaAggron),
    SPECIES_SPRITE(MEDICHAM_MEGA, gMonFrontPic_MegaMedicham),
    SPECIES_SPRITE(MANECTRIC_MEGA, gMonFrontPic_MegaManectric),
    SPECIES_SPRITE(SHARPEDO_MEGA, gMonFrontPic_MegaSharpedo),
    SPECIES_SPRITE(CAMERUPT_MEGA, gMonFrontPic_MegaCamerupt),
    SPECIES_SPRITE(ALTARIA_MEGA, gMonFrontPic_MegaAltaria),
    SPECIES_SPRITE(BANETTE_MEGA, gMonFrontPic_MegaBanette),
    SPECIES_SPRITE(ABSOL_MEGA, gMonFrontPic_MegaAbsol),
    SPECIES_SPRITE(GLALIE_MEGA, gMonFrontPic_MegaGlalie),
    SPECIES_SPRITE(SALAMENCE_MEGA, gMonFrontPic_MegaSalamence),
    SPECIES_SPRITE(METAGROSS_MEGA, gMonFrontPic_MegaMetagross),
    SPECIES_SPRITE(LATIAS_MEGA, gMonFrontPic_MegaLatias),
    SPECIES_SPRITE(LATIOS_MEGA, gMonFrontPic_MegaLatios),
    SPECIES_SPRITE(LOPUNNY_MEGA, gMonFrontPic_MegaLopunny),
    SPECIES_SPRITE(GARCHOMP_MEGA, gMonFrontPic_MegaGarchomp),
    SPECIES_SPRITE(LUCARIO_MEGA, gMonFrontPic_MegaLucario),
    SPECIES_SPRITE(ABOMASNOW_MEGA, gMonFrontPic_MegaAbomasnow),
    SPECIES_SPRITE(GALLADE_MEGA, gMonFrontPic_MegaGallade),
    SPECIES_SPRITE(AUDINO_MEGA, gMonFrontPic_MegaAudino),
    SPECIES_SPRITE(DIANCIE_MEGA, gMonFrontPic_MegaDiancie),

    SPECIES_SPRITE(RAYQUAZA_MEGA, gMonFrontPic_MegaRayquaza),
    SPECIES_SPRITE(KYOGRE_PRIMAL, gMonFrontPic_PrimalKyogre),
    SPECIES_SPRITE(GROUDON_PRIMAL, gMonFrontPic_PrimalGroudon),
