const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(VENUSAUR_MEGA, gMonBackPic_MegaVenusaur),
    SPECIES_SPRITE(CHARIZARD_MEGA_X, gMonBackPic_MegaCharizardX),
    SPECIES_SPRITE(CHARIZARD_MEGA_Y, gMonBackPic_MegaCharizardY),
    SPECIES_SPRITE(BLASTOISE_MEGA, gMonBackPic_MegaBlastoise),
    SPECIES_SPRITE(BEEDRILL_MEGA, gMonBackPic_MegaBeedrill),
    SPECIES_SPRITE(PIDGEOT_MEGA, gMonBackPic_MegaPidgeot),
    SPECIES_SPRITE(ALAKAZAM_MEGA, gMonBackPic_MegaAlakazam),
    SPECIES_SPRITE(SLOWBRO_MEGA, gMonBackPic_MegaSlowbro),
    SPECIES_SPRITE(GENGAR_MEGA, gMonBackPic_MegaGengar),
    SPECIES_SPRITE(KANGASKHAN_MEGA, gMonBackPic_MegaKangaskhan),
    SPECIES_SPRITE(PINSIR_MEGA, gMonBackPic_MegaPinsir),
    SPECIES_SPRITE(GYARADOS_MEGA, gMonBackPic_MegaGyarados),
    SPECIES_SPRITE(AERODACTYL_MEGA, gMonBackPic_MegaAerodactyl),
    SPECIES_SPRITE(MEWTWO_MEGA_X, gMonBackPic_MegaMewtwoX),
    SPECIES_SPRITE(MEWTWO_MEGA_Y, gMonBackPic_MegaMewtwoY),
    SPECIES_SPRITE(AMPHAROS_MEGA, gMonBackPic_MegaAmpharos),
    SPECIES_SPRITE(STEELIX_MEGA, gMonBackPic_MegaSteelix),
    SPECIES_SPRITE(SCIZOR_MEGA, gMonBackPic_MegaScizor),
    SPECIES_SPRITE(HERACROSS_MEGA, gMonBackPic_MegaHeracross),
    SPECIES_SPRITE(HOUNDOOM_MEGA, gMonBackPic_MegaHoundoom),
    SPECIES_SPRITE(TYRANITAR_MEGA, gMonBackPic_MegaTyranitar),
    SPECIES_SPRITE(SCEPTILE_MEGA, gMonBackPic_MegaSceptile),
    SPECIES_SPRITE(BLAZIKEN_MEGA, gMonBackPic_MegaBlaziken),
    SPECIES_SPRITE(SWAMPERT_MEGA, gMonBackPic_MegaSwampert),
    SPECIES_SPRITE(GARDEVOIR_MEGA, gMonBackPic_MegaGardevoir),
    SPECIES_SPRITE(SABLEYE_MEGA, gMonBackPic_MegaSableye),
    SPECIES_SPRITE(MAWILE_MEGA, gMonBackPic_MegaMawile),
    SPECIES_SPRITE(AGGRON_MEGA, gMonBackPic_MegaAggron),
    SPECIES_SPRITE(MEDICHAM_MEGA, gMonBackPic_MegaMedicham),
    SPECIES_SPRITE(MANECTRIC_MEGA, gMonBackPic_MegaManectric),
    SPECIES_SPRITE(SHARPEDO_MEGA, gMonBackPic_MegaSharpedo),
    SPECIES_SPRITE(CAMERUPT_MEGA, gMonBackPic_MegaCamerupt),
    SPECIES_SPRITE(ALTARIA_MEGA, gMonBackPic_MegaAltaria),
    SPECIES_SPRITE(BANETTE_MEGA, gMonBackPic_MegaBanette),
    SPECIES_SPRITE(ABSOL_MEGA, gMonBackPic_MegaAbsol),
    SPECIES_SPRITE(GLALIE_MEGA, gMonBackPic_MegaGlalie),
    SPECIES_SPRITE(SALAMENCE_MEGA, gMonBackPic_MegaSalamence),
    SPECIES_SPRITE(METAGROSS_MEGA, gMonBackPic_MegaMetagross),
    SPECIES_SPRITE(LATIAS_MEGA, gMonBackPic_MegaLatias),
    SPECIES_SPRITE(LATIOS_MEGA, gMonBackPic_MegaLatios),
    SPECIES_SPRITE(LOPUNNY_MEGA, gMonBackPic_MegaLopunny),
    SPECIES_SPRITE(GARCHOMP_MEGA, gMonBackPic_MegaGarchomp),
    SPECIES_SPRITE(LUCARIO_MEGA, gMonBackPic_MegaLucario),
    SPECIES_SPRITE(ABOMASNOW_MEGA, gMonBackPic_MegaAbomasnow),
    SPECIES_SPRITE(GALLADE_MEGA, gMonBackPic_MegaGallade),
    SPECIES_SPRITE(AUDINO_MEGA, gMonBackPic_MegaAudino),
    SPECIES_SPRITE(DIANCIE_MEGA, gMonBackPic_MegaDiancie),

    SPECIES_SPRITE(RAYQUAZA_MEGA, gMonBackPic_MegaRayquaza),
    SPECIES_SPRITE(KYOGRE_PRIMAL, gMonBackPic_PrimalKyogre),
    SPECIES_SPRITE(GROUDON_PRIMAL, gMonBackPic_PrimalGroudon),
