const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(VENUSAUR_MEGA, gMonShinyPalette_MegaVenusaur),
    SPECIES_SHINY_PAL(CHARIZARD_MEGA_X, gMonShinyPalette_MegaCharizardX),
    SPECIES_SHINY_PAL(CHARIZARD_MEGA_Y, gMonShinyPalette_MegaCharizardY),
    SPECIES_SHINY_PAL(BLASTOISE_MEGA, gMonShinyPalette_MegaBlastoise),
    SPECIES_SHINY_PAL(BEEDRILL_MEGA, gMonShinyPalette_MegaBeedrill),
    SPECIES_SHINY_PAL(PIDGEOT_MEGA, gMonShinyPalette_MegaPidgeot),
    SPECIES_SHINY_PAL(ALAKAZAM_MEGA, gMonShinyPalette_MegaAlakazam),
    SPECIES_SHINY_PAL(SLOWBRO_MEGA, gMonShinyPalette_MegaSlowbro),
    SPECIES_SHINY_PAL(GENGAR_MEGA, gMonShinyPalette_MegaGengar),
    SPECIES_SHINY_PAL(KANGASKHAN_MEGA, gMonShinyPalette_MegaKangaskhan),
    SPECIES_SHINY_PAL(PINSIR_MEGA, gMonShinyPalette_MegaPinsir),
    SPECIES_SHINY_PAL(GYARADOS_MEGA, gMonShinyPalette_MegaGyarados),
    SPECIES_SHINY_PAL(AERODACTYL_MEGA, gMonShinyPalette_MegaAerodactyl),
    SPECIES_SHINY_PAL(MEWTWO_MEGA_X, gMonShinyPalette_MegaMewtwoX),
    SPECIES_SHINY_PAL(MEWTWO_MEGA_Y, gMonShinyPalette_MegaMewtwoY),
    SPECIES_SHINY_PAL(AMPHAROS_MEGA, gMonShinyPalette_MegaAmpharos),
    SPECIES_SHINY_PAL(STEELIX_MEGA, gMonShinyPalette_MegaSteelix),
    SPECIES_SHINY_PAL(SCIZOR_MEGA, gMonShinyPalette_MegaScizor),
    SPECIES_SHINY_PAL(HERACROSS_MEGA, gMonShinyPalette_MegaHeracross),
    SPECIES_SHINY_PAL(HOUNDOOM_MEGA, gMonShinyPalette_MegaHoundoom),
    SPECIES_SHINY_PAL(TYRANITAR_MEGA, gMonShinyPalette_MegaTyranitar),
    SPECIES_SHINY_PAL(SCEPTILE_MEGA, gMonShinyPalette_MegaSceptile),
    SPECIES_SHINY_PAL(BLAZIKEN_MEGA, gMonShinyPalette_MegaBlaziken),
    SPECIES_SHINY_PAL(SWAMPERT_MEGA, gMonShinyPalette_MegaSwampert),
    SPECIES_SHINY_PAL(GARDEVOIR_MEGA, gMonShinyPalette_MegaGardevoir),
    SPECIES_SHINY_PAL(SABLEYE_MEGA, gMonShinyPalette_MegaSableye),
    SPECIES_SHINY_PAL(MAWILE_MEGA, gMonShinyPalette_MegaMawile),
    SPECIES_SHINY_PAL(AGGRON_MEGA, gMonShinyPalette_MegaAggron),
    SPECIES_SHINY_PAL(MEDICHAM_MEGA, gMonShinyPalette_MegaMedicham),
    SPECIES_SHINY_PAL(MANECTRIC_MEGA, gMonShinyPalette_MegaManectric),
    SPECIES_SHINY_PAL(SHARPEDO_MEGA, gMonShinyPalette_MegaSharpedo),
    SPECIES_SHINY_PAL(CAMERUPT_MEGA, gMonShinyPalette_MegaCamerupt),
    SPECIES_SHINY_PAL(ALTARIA_MEGA, gMonShinyPalette_MegaAltaria),
    SPECIES_SHINY_PAL(BANETTE_MEGA, gMonShinyPalette_MegaBanette),
    SPECIES_SHINY_PAL(ABSOL_MEGA, gMonShinyPalette_MegaAbsol),
    SPECIES_SHINY_PAL(GLALIE_MEGA, gMonShinyPalette_MegaGlalie),
    SPECIES_SHINY_PAL(SALAMENCE_MEGA, gMonShinyPalette_MegaSalamence),
    SPECIES_SHINY_PAL(METAGROSS_MEGA, gMonShinyPalette_MegaMetagross),
    SPECIES_SHINY_PAL(LATIAS_MEGA, gMonShinyPalette_MegaLatias),
    SPECIES_SHINY_PAL(LATIOS_MEGA, gMonShinyPalette_MegaLatios),
    SPECIES_SHINY_PAL(LOPUNNY_MEGA, gMonShinyPalette_MegaLopunny),
    SPECIES_SHINY_PAL(GARCHOMP_MEGA, gMonShinyPalette_MegaGarchomp),
    SPECIES_SHINY_PAL(LUCARIO_MEGA, gMonShinyPalette_MegaLucario),
    SPECIES_SHINY_PAL(ABOMASNOW_MEGA, gMonShinyPalette_MegaAbomasnow),
    SPECIES_SHINY_PAL(GALLADE_MEGA, gMonShinyPalette_MegaGallade),
    SPECIES_SHINY_PAL(AUDINO_MEGA, gMonShinyPalette_MegaAudino),
    SPECIES_SHINY_PAL(DIANCIE_MEGA, gMonShinyPalette_MegaDiancie),

    SPECIES_SHINY_PAL(RAYQUAZA_MEGA, gMonShinyPalette_MegaRayquaza),
    SPECIES_SHINY_PAL(KYOGRE_PRIMAL, gMonShinyPalette_PrimalKyogre),
    SPECIES_SHINY_PAL(GROUDON_PRIMAL, gMonShinyPalette_PrimalGroudon),
