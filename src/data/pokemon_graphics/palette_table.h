const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(VENUSAUR_MEGA, gMonPalette_MegaVenusaur),
    SPECIES_PAL(CHARIZARD_MEGA_X, gMonPalette_MegaCharizardX),
    SPECIES_PAL(CHARIZARD_MEGA_Y, gMonPalette_MegaCharizardY),
    SPECIES_PAL(BLASTOISE_MEGA, gMonPalette_MegaBlastoise),
    SPECIES_PAL(BEEDRILL_MEGA, gMonPalette_MegaBeedrill),
    SPECIES_PAL(PIDGEOT_MEGA, gMonPalette_MegaPidgeot),
    SPECIES_PAL(ALAKAZAM_MEGA, gMonPalette_MegaAlakazam),
    SPECIES_PAL(SLOWBRO_MEGA, gMonPalette_MegaSlowbro),
    SPECIES_PAL(GENGAR_MEGA, gMonPalette_MegaGengar),
    SPECIES_PAL(KANGASKHAN_MEGA, gMonPalette_MegaKangaskhan),
    SPECIES_PAL(PINSIR_MEGA, gMonPalette_MegaPinsir),
    SPECIES_PAL(GYARADOS_MEGA, gMonPalette_MegaGyarados),
    SPECIES_PAL(AERODACTYL_MEGA, gMonPalette_MegaAerodactyl),
    SPECIES_PAL(MEWTWO_MEGA_X, gMonPalette_MegaMewtwoX),
    SPECIES_PAL(MEWTWO_MEGA_Y, gMonPalette_MegaMewtwoY),
    SPECIES_PAL(AMPHAROS_MEGA, gMonPalette_MegaAmpharos),
    SPECIES_PAL(STEELIX_MEGA, gMonPalette_MegaSteelix),
    SPECIES_PAL(SCIZOR_MEGA, gMonPalette_MegaScizor),
    SPECIES_PAL(HERACROSS_MEGA, gMonPalette_MegaHeracross),
    SPECIES_PAL(HOUNDOOM_MEGA, gMonPalette_MegaHoundoom),
    SPECIES_PAL(TYRANITAR_MEGA, gMonPalette_MegaTyranitar),
    SPECIES_PAL(SCEPTILE_MEGA, gMonPalette_MegaSceptile),
    SPECIES_PAL(BLAZIKEN_MEGA, gMonPalette_MegaBlaziken),
    SPECIES_PAL(SWAMPERT_MEGA, gMonPalette_MegaSwampert),
    SPECIES_PAL(GARDEVOIR_MEGA, gMonPalette_MegaGardevoir),
    SPECIES_PAL(SABLEYE_MEGA, gMonPalette_MegaSableye),
    SPECIES_PAL(MAWILE_MEGA, gMonPalette_MegaMawile),
    SPECIES_PAL(AGGRON_MEGA, gMonPalette_MegaAggron),
    SPECIES_PAL(MEDICHAM_MEGA, gMonPalette_MegaMedicham),
    SPECIES_PAL(MANECTRIC_MEGA, gMonPalette_MegaManectric),
    SPECIES_PAL(SHARPEDO_MEGA, gMonPalette_MegaSharpedo),
    SPECIES_PAL(CAMERUPT_MEGA, gMonPalette_MegaCamerupt),
    SPECIES_PAL(ALTARIA_MEGA, gMonPalette_MegaAltaria),
    SPECIES_PAL(BANETTE_MEGA, gMonPalette_MegaBanette),
    SPECIES_PAL(ABSOL_MEGA, gMonPalette_MegaAbsol),
    SPECIES_PAL(GLALIE_MEGA, gMonPalette_MegaGlalie),
    SPECIES_PAL(SALAMENCE_MEGA, gMonPalette_MegaSalamence),
    SPECIES_PAL(METAGROSS_MEGA, gMonPalette_MegaMetagross),
    SPECIES_PAL(LATIAS_MEGA, gMonPalette_MegaLatias),
    SPECIES_PAL(LATIOS_MEGA, gMonPalette_MegaLatios),
    SPECIES_PAL(LOPUNNY_MEGA, gMonPalette_MegaLopunny),
    SPECIES_PAL(GARCHOMP_MEGA, gMonPalette_MegaGarchomp),
    SPECIES_PAL(LUCARIO_MEGA, gMonPalette_MegaLucario),
    SPECIES_PAL(ABOMASNOW_MEGA, gMonPalette_MegaAbomasnow),
    SPECIES_PAL(GALLADE_MEGA, gMonPalette_MegaGallade),
    SPECIES_PAL(AUDINO_MEGA, gMonPalette_MegaAudino),
    SPECIES_PAL(DIANCIE_MEGA, gMonPalette_MegaDiancie),

    SPECIES_PAL(RAYQUAZA_MEGA, gMonPalette_MegaRayquaza),
    SPECIES_PAL(KYOGRE_PRIMAL, gMonPalette_PrimalKyogre),
    SPECIES_PAL(GROUDON_PRIMAL, gMonPalette_PrimalGroudon),
