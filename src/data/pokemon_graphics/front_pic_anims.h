...
static const union AnimCmd sAnim_CREWMATE_1[] =
{
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(0, 20),
    ANIMCMD_END,
...
static const union AnimCmd sAnim_DUMPY_1[] =
{
    ANIMCMD_FRAME(0, 50),
    ANIMCMD_FRAME(1, 25),
    ANIMCMD_FRAME(0, 20),
...
static const union AnimCmd *const sAnims_CREWMATE[] ={
    sAnim_GeneralFrame0,
    sAnim_CREWMATE_1,
};
...
static const union AnimCmd *const sAnims_DUMPY[] ={
    sAnim_GeneralFrame0,
    sAnim_DUMPY_1,
};
