...
static const u32 sHeldItemGfx[] = INCBIN_U32("build/assets/graphics/party_menu/hold_icons.4bpp");
static const u16 sHeldItemPalette[] = INCBIN_U16("build/assets/graphics/party_menu/hold_icons.gbapal");
