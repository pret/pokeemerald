...
static const u32 sWirelessCloseup_Map[] = INCBIN_U32("build/assets/graphics/trade/crossing_highlight_wireless.bin.lz");
...
static const u32 sWirelessSignal_Tilemap[] = INCBIN_U32("build/assets/graphics/trade/wireless_signal.bin.lz");
