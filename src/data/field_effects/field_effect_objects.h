const struct SpritePalette gSpritePalette_GeneralFieldEffect0 = {gFieldEffectObjectPalette0, PAL_TAG_FLDEFF_GENERAL_0};
const struct SpritePalette gSpritePalette_GeneralFieldEffect1 = {gFieldEffectObjectPalette1, PAL_TAG_FLDEFF_GENERAL_1};
...
const struct SpriteTemplate gFieldEffectObjectTemplate_TallGrass = {
    .tileTag = TAG_NONE,
    .paletteTag = PAL_TAG_FLDEFF_GENERAL_1,
...
const struct SpriteTemplate gFieldEffectObjectTemplate_GroundImpactDust = {
    .tileTag = TAG_NONE,
    .paletteTag = PAL_TAG_FLDEFF_GENERAL_0,
    .oam = &gObjectEventBaseOam_16x8,
...
const struct SpritePalette gSpritePalette_Ash = {gFieldEffectPal_Ash, PAL_TAG_FLDEFF_ASH};
...
const struct SpriteTemplate gFieldEffectObjectTemplate_SmallSparkle = {
    .tileTag = TAG_NONE,
    .paletteTag = PAL_TAG_FLDEFF_SMALL_SPARKLE,
    .oam = &gObjectEventBaseOam_16x16,
...
const struct SpritePalette gSpritePalette_SmallSparkle = {gFieldEffectPal_SmallSparkle, PAL_TAG_FLDEFF_SMALL_SPARKLE};
...
static const struct SpritePalette sSpritePalette_Unused = {gObjectEventPal_Npc3, PAL_TAG_FLDEFF_UNKNOWN};
