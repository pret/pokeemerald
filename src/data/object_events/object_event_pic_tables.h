...
static const struct SpriteFrameImage sPicTable_Fren[] = {
    overworld_frame(gObjectEventPic_Fren, 2, 4, 0),
    overworld_frame(gObjectEventPic_Fren, 2, 4, 1),
    overworld_frame(gObjectEventPic_Fren, 2, 4, 2),
    overworld_frame(gObjectEventPic_Fren, 2, 4, 3),
    overworld_frame(gObjectEventPic_Fren, 2, 4, 4),
    overworld_frame(gObjectEventPic_Fren, 2, 4, 5),
    overworld_frame(gObjectEventPic_Fren, 2, 4, 6),
    overworld_frame(gObjectEventPic_Fren, 2, 4, 7),
    overworld_frame(gObjectEventPic_Fren, 2, 4, 8),
};

static const struct SpriteFrameImage sPicTable_Chode[] = { 
    overworld_frame(gObjectEventPic_Chode, 2, 4, 0),
    overworld_frame(gObjectEventPic_Chode, 2, 4, 1),
    overworld_frame(gObjectEventPic_Chode, 2, 4, 2),
    overworld_frame(gObjectEventPic_Chode, 2, 4, 3),
    overworld_frame(gObjectEventPic_Chode, 2, 4, 4),
    overworld_frame(gObjectEventPic_Chode, 2, 4, 5),
    overworld_frame(gObjectEventPic_Chode, 2, 4, 6),
    overworld_frame(gObjectEventPic_Chode, 2, 4, 7),
    overworld_frame(gObjectEventPic_Chode, 2, 4, 8),
};
...
static const struct SpriteFrameImage sPicTable_Joshi[] = {
    ...
    overworld_frame(gObjectEventPic_Joshi, 2, 4, 3),
    overworld_frame(gObjectEventPic_Joshi, 2, 4, 4),
    overworld_frame(gObjectEventPic_Joshi, 2, 4, 5),
    overworld_frame(gObjectEventPic_Joshi, 2, 4, 6),
...
static const struct SpriteFrameImage sPicTable_Mkdee[] = {
    obj_frame_tiles(gObjectEventPic_Mkdee),
    obj_frame_tiles(gObjectEventPic_Mkdee),
    obj_frame_tiles(gObjectEventPic_Mkdee),
    obj_frame_tiles(gObjectEventPic_Mkdee),
    obj_frame_tiles(gObjectEventPic_Mkdee),
