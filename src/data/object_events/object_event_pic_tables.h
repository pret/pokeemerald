...
static const struct SpriteFrameImage sPicTable_Phoebe[] = {
    overworld_ascending_frames(gObjectEventPic_Phoebe, 4, 4),
};
...
static const struct SpriteFrameImage sPicTable_Lyra[] = {
    overworld_ascending_frames(gObjectEventPic_Lyra, 4, 4),
};

static const struct SpriteFrameImage sPicTable_Ethan[] = {
    overworld_ascending_frames(gObjectEventPic_Ethan, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_Lucas[] = {
    overworld_ascending_frames(gObjectEventPic_Lucas, 2, 4),
};
