...
const u32 gDumpy_Mon[] = INCBIN_U32("graphics/pokemon/dumpy/anim_front.4bpp.lz");
const u32 gDumpyPal_Mon[] = INCBIN_U32("graphics/pokemon/dumpy/normal.gbapal.lz");
...
//        CreateSprite(const struct SpriteTemplate *template, s16 x, s16 y, u8 subpriority)
        CreateSprite(&sMonSpriteTemplate, 120, 110, 0);
