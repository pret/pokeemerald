...
static const u16 sOptionMenuText_Pal[] = INCBIN_U16("build/assets/graphics/interface/option_menu_text.gbapal");
// note: this is only used in the Japanese release
static const u8 sEqualSignGfx[] = INCBIN_U8("build/assets/graphics/interface/option_menu_equals_sign.4bpp");
