...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN_1, TRAINER_RANDOM_BATTLE_1, TRAINER_RANDOM_BATTLE_2, TRAINER_ARCHIE_PIT_BOSS, TRAINER_EDWIN_5, ROUTE110),
...
void ConfigureAndSetUpOneTrainerBattle(u8 trainerObjEventId, const u8 *trainerScript)
{
    ...
    DebugPrintf("Configure One Trainer Battle: %d", 0);
...
void ConfigureTwoTrainersBattle(u8 trainerObjEventId, const u8 *trainerScript)
{
    ...
    gSpecialVar_LastTalked = gObjectEvents[trainerObjEventId].localId;
    BattleSetup_ConfigureTrainerBattle(trainerScript + 1);
    DebugPrintf("Configure Two Trainers Battle: %d", 0);
}
