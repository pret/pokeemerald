...
#define REMATCH(name, idCount, map)         \
{                                           \
    .trainerIds = REMATCH##idCount(name),   \
    .mapGroup = MAP_GROUP(map),             \
    .mapNum = MAP_NUM(map)                  \
}
#define REMATCH5(name)  \
{                       \
    TRAINER_##name##_1, \
    TRAINER_##name##_2, \
    TRAINER_##name##_3, \
...
{
    [REMATCH_ROSE] = REMATCH(ROSE, 5, ROUTE118),
    [REMATCH_ANDRES] = REMATCH(ANDRES, 5, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(DUSTY, 5, ROUTE111),
    [REMATCH_LOLA] = REMATCH(LOLA, 5, ROUTE109),
    [REMATCH_RICKY] = REMATCH(RICKY, 5, ROUTE109),
    [REMATCH_LILA_AND_ROY] = REMATCH(LILA_AND_ROY, 5, ROUTE124),
    [REMATCH_CRISTIN] = REMATCH(CRISTIN, 5, ROUTE121),
    [REMATCH_BROOKE] = REMATCH(BROOKE, 5, ROUTE111),
    [REMATCH_WILTON] = REMATCH(WILTON, 5, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(VALERIE, 5, MT_PYRE_6F),
    [REMATCH_CINDY] =
    {
        .trainerIds = {TRAINER_CINDY_1, TRAINER_CINDY_3, TRAINER_CINDY_4, TRAINER_CINDY_5, TRAINER_CINDY_6},
        .mapGroup = MAP_GROUP(ROUTE104),
        .mapNum = MAP_NUM(ROUTE104)
    },
    [REMATCH_THALIA] = REMATCH(THALIA, 5, ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(JESSICA, 5, ROUTE121),
    [REMATCH_WINSTON] = REMATCH(WINSTON, 5, ROUTE104),
    [REMATCH_STEVE] = REMATCH(STEVE, 5, ROUTE114),
    [REMATCH_TONY] = REMATCH(TONY, 5, ROUTE107),
    [REMATCH_NOB] = REMATCH(NOB, 5, ROUTE115),
    [REMATCH_KOJI] = REMATCH(KOJI, 5, ROUTE127),
    [REMATCH_FERNANDO] = REMATCH(FERNANDO, 5, ROUTE123),
    [REMATCH_DALTON] = REMATCH(DALTON, 5, ROUTE118),
    [REMATCH_BERNIE] = REMATCH(BERNIE, 5, ROUTE114),
    [REMATCH_ETHAN] = REMATCH(ETHAN, 5, JAGGED_PASS),
    [REMATCH_JOHN_AND_JAY] = REMATCH(JOHN_AND_JAY, 5, METEOR_FALLS_1F_2R),
    [REMATCH_JEFFREY] = REMATCH(JEFFREY, 5, ROUTE120),
    [REMATCH_CAMERON] = REMATCH(CAMERON, 5, ROUTE123),
    [REMATCH_JACKI] = REMATCH(JACKI, 5, ROUTE123),
    [REMATCH_WALTER] = REMATCH(WALTER, 5, ROUTE121),
    [REMATCH_KAREN] = REMATCH(KAREN, 5, ROUTE116),
    [REMATCH_JERRY] = REMATCH(JERRY, 5, ROUTE116),
    [REMATCH_ANNA_AND_MEG] = REMATCH(ANNA_AND_MEG, 5, ROUTE117),
    [REMATCH_ISABEL] = REMATCH(ISABEL, 5, ROUTE110),
    [REMATCH_MIGUEL] = REMATCH(MIGUEL, 5, ROUTE103),
    [REMATCH_TIMOTHY] = REMATCH(TIMOTHY, 5, ROUTE115),
    [REMATCH_SHELBY] = REMATCH(SHELBY, 5, MT_CHIMNEY),
    [REMATCH_CALVIN] = REMATCH(CALVIN, 5, ROUTE102),
    [REMATCH_ELLIOT] = REMATCH(ELLIOT, 5, ROUTE106),
    [REMATCH_ISAIAH] = REMATCH(ISAIAH, 5, ROUTE128),
    [REMATCH_MARIA] = REMATCH(MARIA, 5, ROUTE117),
    [REMATCH_ABIGAIL] =REMATCH(ABIGAIL, 5, ROUTE110),
    [REMATCH_DYLAN] = REMATCH(DYLAN, 5, ROUTE117),
    [REMATCH_KATELYN] = REMATCH(KATELYN, 5, ROUTE128),
    [REMATCH_BENJAMIN] = REMATCH(BENJAMIN, 5, ROUTE110),
    [REMATCH_PABLO] = REMATCH(PABLO, 5, ROUTE126),
    [REMATCH_NICOLAS] = REMATCH(NICOLAS, 5, METEOR_FALLS_1F_2R),
    [REMATCH_ROBERT] = REMATCH(ROBERT, 5, ROUTE120),
    [REMATCH_LAO] = REMATCH(LAO, 5, ROUTE113),
    [REMATCH_CYNDY] = REMATCH(CYNDY, 5, ROUTE115),
    [REMATCH_MADELINE] = REMATCH(MADELINE, 5, ROUTE113),
    [REMATCH_JENNY] = REMATCH(JENNY, 5, ROUTE124),
    [REMATCH_DIANA] = REMATCH(DIANA, 5, JAGGED_PASS),
    [REMATCH_AMY_AND_LIV] =
    {
        .trainerIds = {TRAINER_AMY_AND_LIV_1, TRAINER_AMY_AND_LIV_2, TRAINER_AMY_AND_LIV_4, TRAINER_AMY_AND_LIV_5, TRAINER_AMY_AND_LIV_6},
        .mapGroup = MAP_GROUP(ROUTE103),
        .mapNum = MAP_NUM(ROUTE103)
    },
    [REMATCH_ERNEST] = REMATCH(ERNEST, 5, ROUTE125),
    [REMATCH_CORY] = REMATCH(CORY, 5, ROUTE108),
    [REMATCH_EDWIN] = REMATCH(EDWIN, 5, ROUTE110),
    [REMATCH_LYDIA] = REMATCH(LYDIA, 5, ROUTE117),
    [REMATCH_ISAAC] = REMATCH(ISAAC, 5, ROUTE117),
    [REMATCH_GABRIELLE] = REMATCH(GABRIELLE, 5, MT_PYRE_3F),
    [REMATCH_CATHERINE] = REMATCH(CATHERINE, 5, ROUTE119),
    [REMATCH_JACKSON] = REMATCH(JACKSON, 5, ROUTE119),
    [REMATCH_HALEY] = REMATCH(HALEY, 5, ROUTE104),
    [REMATCH_JAMES] = REMATCH(JAMES, 5, PETALBURG_WOODS),
    [REMATCH_TRENT] = REMATCH(TRENT, 5, ROUTE112),
    [REMATCH_SAWYER] = REMATCH(SAWYER, 5, MT_CHIMNEY),
    [REMATCH_KIRA_AND_DAN] = REMATCH(KIRA_AND_DAN, 5, ABANDONED_SHIP_ROOMS2_1F),
    [REMATCH_WALLY_3] =
    {
        .trainerIds = {TRAINER_WALLY_3, TRAINER_WALLY_4, TRAINER_WALLY_5, TRAINER_WALLY_6, TRAINER_WALLY_6},
        .mapGroup = MAP_GROUP(VICTORY_ROAD_1F),
        .mapNum = MAP_NUM(VICTORY_ROAD_1F)
    },
    [REMATCH_ROXANNE] = REMATCH(ROXANNE, 5, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(BRAWLY, 5, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(WATTSON, 5, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(FLANNERY, 5, LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(NORMAN, 5, PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(WINONA, 5, FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TATE_AND_LIZA, 5, MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(JUAN, 5, SOOTOPOLIS_CITY),
    [REMATCH_SIDNEY] = REMATCH(SIDNEY, 1, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(PHOEBE, 1, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(GLACIA, 1, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(DRAKE, 1, EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(WALLACE, 1, EVER_GRANDE_CITY),
};
