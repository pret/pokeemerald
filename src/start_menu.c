...
static void ShowSafariBallsWindow(void)
{
    ...
    StringExpandPlaceholders(gStringVarBuffer, gText_SafariBallStock);
    AddTextPrinterParameterized(sSafariBallsWindowId, FONT_NORMAL, gStringVarBuffer, 0, 1, TEXT_SKIP_DRAW, NULL);
...
static void ShowPyramidFloorWindow(void)
{
    ...
    StringExpandPlaceholders(gStringVarBuffer, gText_BattlePyramidFloor);
    AddTextPrinterParameterized(sBattlePyramidFloorWindowId, FONT_NORMAL, gStringVarBuffer, 0, 1, TEXT_SKIP_DRAW, NULL);
...
static bool32 PrintStartMenuActions(s8 *pIndex, u32 count)
{
    ...
    do
    {
        ...
        {
            StringExpandPlaceholders(gStringVarBuffer, sStartMenuItems[sCurrentStartMenuActions[index]].text);
            AddTextPrinterParameterized(GetStartMenuWindowId(), FONT_NORMAL, gStringVarBuffer, 8, (index << 4) + 9, TEXT_SKIP_DRAW, NULL);
        }
...
static void ShowSaveMessage(const u8 *message, u8 (*saveCallback)(void))
{
    StringExpandPlaceholders(gStringVarBuffer, message);
...
static void ShowSaveInfoWindow(void)
{
    ...
    // Print region name
    yOffset = 1;
    BufferSaveMenuText(SAVE_MENU_LOCATION, gStringVarBuffer, TEXT_COLOR_GREEN);
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gStringVarBuffer, 0, yOffset, TEXT_SKIP_DRAW, NULL);

    // Print player name
    yOffset += 16;
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gText_SavingPlayer, 0, yOffset, TEXT_SKIP_DRAW, NULL);
    BufferSaveMenuText(SAVE_MENU_NAME, gStringVarBuffer, color);
    xOffset = GetStringRightAlignXOffset(FONT_NORMAL, gStringVarBuffer, 0x70);
    PrintPlayerNameOnWindow(sSaveInfoWindowId, gStringVarBuffer, xOffset, yOffset);

    // Print badge count
    yOffset += 16;
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gText_SavingBadges, 0, yOffset, TEXT_SKIP_DRAW, NULL);
    BufferSaveMenuText(SAVE_MENU_BADGES, gStringVarBuffer, color);
    xOffset = GetStringRightAlignXOffset(FONT_NORMAL, gStringVarBuffer, 0x70);
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gStringVarBuffer, xOffset, yOffset, TEXT_SKIP_DRAW, NULL);
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET) == TRUE)
    {
        ...
        BufferSaveMenuText(SAVE_MENU_CAUGHT, gStringVarBuffer, color);
        xOffset = GetStringRightAlignXOffset(FONT_NORMAL, gStringVarBuffer, 0x70);
        AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gStringVarBuffer, xOffset, yOffset, TEXT_SKIP_DRAW, NULL);
    }
    ...
    BufferSaveMenuText(SAVE_MENU_PLAY_TIME, gStringVarBuffer, color);
    xOffset = GetStringRightAlignXOffset(FONT_NORMAL, gStringVarBuffer, 0x70);
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gStringVarBuffer, xOffset, yOffset, TEXT_SKIP_DRAW, NULL);
