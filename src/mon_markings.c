...
static const u16 sMonMarkings_Pal[] = INCBIN_U16("build/assets/graphics/interface/mon_markings.gbapal");
static const u8 sMonMarkings_Gfx[] = INCBIN_U8("build/assets/graphics/interface/mon_markings.4bpp");
