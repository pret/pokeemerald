...
const u16 gStandardMenuPalette[] = INCBIN_U16("build/assets/graphics/interface/std_menu.gbapal");
...
static const u16 sHofPC_TopBar_Pal[] = INCBIN_U16("build/assets/graphics/interface/hof_pc_topbar.gbapal");
