...
void WindowFunc_DrawDialogueFrame(u8 bg, u8 tilemapLeft, u8 tilemapTop, u8 width, u8 height, u8 paletteNum)
{
    ...
    FillBgTilemapBufferRect(bg,
                            ...
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            BG_TILE_H_FLIP(DLG_WINDOW_BASE_TILE_NUM + 8),
                            tilemapLeft + width,
                            tilemapTop + 1,
                            1,
                            3,
    ...
    FillBgTilemapBufferRect(bg,
                            ...
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            BG_TILE_H_FLIP(DLG_WINDOW_BASE_TILE_NUM + 13),
                            tilemapLeft + width,
                            tilemapTop,
                            1,
                            1,
    ...
    FillBgTilemapBufferRect(bg,
                            ...
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            0xC00 | (DLG_WINDOW_BASE_TILE_NUM + 13),
                            tilemapLeft + width,
                            tilemapTop + 3,
                            1,
                            1,
