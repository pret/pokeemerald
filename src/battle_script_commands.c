...
static const u8 sForbiddenMoves[MOVES_COUNT] =
{
    ...
    [MOVE_BEHEMOTH_BASH] = FORBIDDEN_METRONOME,
    [MOVE_BEHEMOTH_BLADE] = FORBIDDEN_METRONOME,
    ...
    [MOVE_CRAFTY_SHIELD] = FORBIDDEN_METRONOME | FORBIDDEN_COPYCAT,
    ...
    [MOVE_PHANTOM_FORCE] = FORBIDDEN_ASSIST,
    ...
    [MOVE_SHADOW_FORCE] = FORBIDDEN_ASSIST,
