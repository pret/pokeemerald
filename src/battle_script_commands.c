...
FLAG_BADGE01_GET,
FLAG_BADGE02_GET,
FLAG_DEFEATED_RIVAL_ROUTE_110,
FLAG_BADGE03_GET,
FLAG_DEFEATED_EVIL_TEAM_MT_CHIMNEY,
FLAG_BADGE04_GET,
FLAG_BADGE05_GET,
FLAG_DEFEATED_RIVAL_ROUTE_119,
FLAG_BADGE06_GET,
...
FLAG_DEFEATED_WALLACE
};

//Each exp cap is based on the trainer's ace
//E.g. Roxanne has a level 16 nosepass, and 4096 is the amount of exp needed for a pokemon in the most common experience group to get to level 16
