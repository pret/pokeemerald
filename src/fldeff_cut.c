...
// IWRAM variables
static BSS_DATA u8 sCutSquareSide;
static BSS_DATA u8 sTileCountFromPlayer_X;
static BSS_DATA u8 sTileCountFromPlayer_Y;
static BSS_DATA u32 sUnused;
static BSS_DATA bool8 sHyperCutTiles[CUT_HYPER_AREA];
