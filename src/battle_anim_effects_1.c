...
{
    {TAG_BATTLE_ANIM_MUSIC_NOTES,     RGB(31, 31, 31), RGB(31, 26, 28), RGB(31, 22, 26), RGB(31, 17, 24), RGB(31, 13, 22)},
    {TAG_BATTLE_ANIM_BENT_SPOON,      RGB(31, 31, 31), RGB(25, 31, 26), RGB(20, 31, 21), RGB(15, 31, 16), RGB(10, 31, 12)},
    {TAG_BATTLE_ANIM_SPHERE_TO_CUBE,  RGB(31, 31, 31), RGB(31, 31, 24), RGB(31, 31, 17), RGB(31, 31, 10), RGB(31, 31, 3)},
    {TAG_BATTLE_ANIM_LARGE_FRESH_EGG, RGB(31, 31, 31), RGB(26, 28, 31), RGB(21, 26, 31), RGB(16, 24, 31), RGB(12, 22, 31)},
};
...
void AnimTask_CycleMagicalLeafPal(u8 taskId)
{
    ...
    {
    case 0:
        task->data[8] = IndexOfSpritePaletteTag(TAG_BATTLE_ANIM_LEAF) * 16 + 256;
        task->data[12] = IndexOfSpritePaletteTag(TAG_BATTLE_ANIM_RAZOR_LEAF) * 16 + 256;
        task->data[0]++;
        break;
    case 1:
        if (++task->data[9] >= 0)
...
static void AnimProtect(struct Sprite* sprite)
{
    ...
    sprite->data[0] = gBattleAnimArgs[2];
    sprite->data[2] = (IndexOfSpritePaletteTag(TAG_BATTLE_ANIM_PROTECT) << 4) + 0x100;
    sprite->data[7] = 16;
