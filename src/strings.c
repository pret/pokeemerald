...
const u8 gText_EmptyPkmnCategory[] = _("                       POKéMON"); // Used in French and Italian versions
const u8 gText_EmptyHeight[] = _("{CLEAR_TO 0x0C}    '    ”"); // Used in French and Italian versions
const u8 gText_EmptyWeight[] = _("        .   lbs."); // Used in French and Italian versions
const u8 gText_EmptyPokedexInfo1[] = _(""); // Used in French and Italian versions
const u8 gText_CryOf[] = _("CRY OF");
const u8 gText_EmptyPokedexInfo2[] = _(""); // Used in French and Italian versions
