...
const u8 gText_PartyMenu_ChoosePkmn[] = _("Choose a POKéMON.");
const u8 gText_PartyMenu_MovePkmnPrompt[] = _("Move to where?");
const u8 gText_PartyMenu_TeachMovePrompt[] = _("Teach which POKéMON?");
const u8 gText_PartyMenu_UseItemPrompt[] = _("Use on which POKéMON?");
const u8 gText_PartyMenu_GiveItemPrompt[] = _("Give to which POKéMON?");
const u8 gText_PartyMenu_DoWhatPrompt[] = _("Do what with this {PKMN}?");
const u8 gText_PartyMenu_CantCut[] = _("There's nothing to CUT.");
const u8 gText_PartyMenu_CantSurf[] = _("You can't SURF here.");
const u8 gText_PartyMenu_AlreadySurfing[] = _("You're already SURFING.");
const u8 gText_PartyMenu_CantUse[] = _("Can't use that here.");
const u8 gText_PartyMenu_RestorePPPrompt[] = _("Restore which move?");
const u8 gText_PartyMenu_BoostPPPrompt[] = _("Boost PP of which move?");
const u8 gText_PartyMenu_DoWhatItemPrompt[] = _("Do what with an item?");
const u8 gText_PartyMenu_NoQualifiedPkmn[] = _("No POKéMON for battle!");
const u8 gText_PartyMenu_ChoosePkmn2[] = _("Choose a POKéMON.");
const u8 gText_PartyMenu_NotEnoughHP[] = _("Not enough HP…");
const u8 gText_PartyMenu_NumPkmnNeeded[] = _("{STR_VAR_1} POKéMON are needed.");
const u8 gText_PartyMenu_SpeciesClauseError[] = _("POKéMON can't be the same.");
const u8 gText_PartyMenu_ItemClauseError[] = _("No identical hold items.");
const u8 gText_PartyMenu_SurfDisallowed[] = _("The current is much too fast!");
const u8 gText_PartyMenu_DoWhatMailPrompt[] = _("Do what with the MAIL?");
const u8 gText_PartyMenu_ChoosePkmnOrCancel[] = _("Choose POKéMON or CANCEL.");
const u8 gText_PartyMenu_ChoosePkmnConfirm[] = _("Choose POKéMON and confirm.");
const u8 gText_PartyMenu_CantBecauseCycling[] = _("Let's enjoy cycling!");
const u8 gText_PartyMenu_AlreadyUsing[] = _("This is in use already.");
const u8 gText_PartyMenu_AlreadyHoldingItem[] = _("{STR_VAR_1} is already holding\none {STR_VAR_2}.");
const u8 gText_PartyMenu_NoUse[] = _("No use.");
const u8 gText_PartyMenu_Qualified[] = _("ABLE");
const u8 gText_PartyMenu_Entered1[] = _("FIRST");
const u8 gText_PartyMenu_Entered2[] = _("SECOND");
const u8 gText_PartyMenu_Entered3[] = _("THIRD");
const u8 gText_PartyMenu_Able[] = _("ABLE");
const u8 gText_PartyMenu_NotAble[] = _("NOT ABLE");
const u8 gText_PartyMenu_AbleBang[] = _("ABLE!");
const u8 gText_PartyMenu_NotAbleBang[] = _("NOT ABLE!");
const u8 gText_PartyMenu_Learned[] = _("LEARNED");
const u8 gText_PartyMenu_Have[] = _("HAVE");
const u8 gText_PartyMenu_DontHave[] = _("DON'T HAVE");
const u8 gText_PartyMenu_Entered4[] = _("FOURTH");
