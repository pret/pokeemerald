...
const u8 gText_SelectOwnershipMode[] = _("Select OWNED/SEEN Pokémon\nonly.");
...
const u8 gText_DexOwnedTitle[] = _("OWNED");
const u8 gText_DexSeenTitle[] = _("SEEN");
const u8 gText_DexPartyTitle[] = _("PARTY");
const u8 gText_DexSortNumericalTitle[] = _("NUMERICAL MODE");
const u8 gText_DexSortOwnedTitle[] = _("ONLY OWNED");
...
const u8 gText_DexOwnedDescription[] = _("Only owned Pokémon");
const u8 gText_DexSeenDescription[] = _("Only seen Pokémon");
const u8 gText_DexPartyDescription[] = _("Only Party Pokémon");
const u8 gText_DexSortNumericalDescription[] = _("POKéMON are listed according to their\nnumber.");
const u8 gText_DexSortOwnedDescription[] = _("Only owned POKéMON are listed.");
...
const u8 gText_LostRunHOF[] = _("Your run has ended");
...
const u8 gText_LeagueChamp[] = _("PIT OF 100 TRIALS CHAMPION!\nCONGRATULATIONS!                   v1.8.0 Gen3");
const u8 gText_LostRunChamp[] = _("Good Progress!\nand Good Luck Next Time!         v1.8.0 Gen3");
#endif
#ifdef PIT_GEN_5_MODE
const u8 gText_LeagueChamp[] = _("PIT OF 100 TRIALS CHAMPION!\nCONGRATULATIONS!                   v1.8.0 Gen5");
const u8 gText_LostRunChamp[] = _("Good Progress!\nand Good Luck Next Time!         v1.8.0 Gen5");
#endif
#ifdef PIT_GEN_9_MODE
const u8 gText_LeagueChamp[] = _("PIT OF 100 TRIALS CHAMPION!\nCONGRATULATIONS!                   v1.8.0 Gen9");
const u8 gText_LostRunChamp[] = _("Good Progress!\nand Good Luck Next Time!         v1.8.0 Gen9");
#endif
...
const u8 gText_TeachWhichMove[] = _("Which move should I teach?");
...
const u8 gText_HpEVResetToZero[] = _("{STR_VAR_1}'s HP EVs\nwere reset to zero!{PAUSE_UNTIL_PRESS}");
const u8 gText_AtkEVResetToZero[] = _("{STR_VAR_1}'s Attack EVs\nwere reset to zero!{PAUSE_UNTIL_PRESS}");
const u8 gText_DefEVResetToZero[] = _("{STR_VAR_1}'s Defense EVs\nwere reset to zero!{PAUSE_UNTIL_PRESS}");
