...
const u8 gText_EmptyPkmnCategory[] = _("                       POKéMON"); // Unused in English
const u8 gText_EmptyHeight[] = _("{CLEAR_TO 0x0C}    '    ”"); // Unused in English
const u8 gText_EmptyWeight[] = _("        .   lbs."); // Unused in English
const u8 gText_EmptyPokedexInfo1[] = _(""); // Unused in English
const u8 gText_CryOf[] = _("CRY OF");
const u8 gText_EmptyPokedexInfo2[] = _(""); // Unused in English
