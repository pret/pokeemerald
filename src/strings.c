...
const u8 gText_NuzlockeAlreadyEncountered[] = _("You may no longer\ncatch POKéMON here.{PAUSE_UNTIL_PRESS}");
const u8 gText_NuzlockeSpeciesClause[] = _("You may no longer\ncatch this species.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_AnotherPkmnAlreadyKnows[] = _("Another Pokemon already\nknows {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
