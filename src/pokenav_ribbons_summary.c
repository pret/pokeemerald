...
void FreeRibbonsSummaryScreen2(void)
{
    ...
    FreeSpriteTilesByTag(GFX_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_BIG);
    FreeSpritePaletteByTag(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1);
    FreeSpritePaletteByTag(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_2);
    FreeSpritePaletteByTag(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_3);
    FreeSpritePaletteByTag(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_4);
    FreeSpritePaletteByTag(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_5);
...
#define TO_PAL_OFFSET(palNum) ((palNum) - PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1)
...
{
    [CHAMPION_RIBBON]      = { RIBBONGFX_CHAMPION,       TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1)},
    [COOL_RIBBON_NORMAL]   = { RIBBONGFX_CONTEST_NORMAL, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1)},
    [COOL_RIBBON_SUPER]    = { RIBBONGFX_CONTEST_SUPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1)},
    [COOL_RIBBON_HYPER]    = { RIBBONGFX_CONTEST_HYPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1)},
    [COOL_RIBBON_MASTER]   = { RIBBONGFX_CONTEST_MASTER, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1)},
    [BEAUTY_RIBBON_NORMAL] = { RIBBONGFX_CONTEST_NORMAL, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_2)},
    [BEAUTY_RIBBON_SUPER]  = { RIBBONGFX_CONTEST_SUPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_2)},
    [BEAUTY_RIBBON_HYPER]  = { RIBBONGFX_CONTEST_HYPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_2)},
    [BEAUTY_RIBBON_MASTER] = { RIBBONGFX_CONTEST_MASTER, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_2)},
    [CUTE_RIBBON_NORMAL]   = { RIBBONGFX_CONTEST_NORMAL, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_3)},
    [CUTE_RIBBON_SUPER]    = { RIBBONGFX_CONTEST_SUPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_3)},
    [CUTE_RIBBON_HYPER]    = { RIBBONGFX_CONTEST_HYPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_3)},
    [CUTE_RIBBON_MASTER]   = { RIBBONGFX_CONTEST_MASTER, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_3)},
    [SMART_RIBBON_NORMAL]  = { RIBBONGFX_CONTEST_NORMAL, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_4)},
    [SMART_RIBBON_SUPER]   = { RIBBONGFX_CONTEST_SUPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_4)},
    [SMART_RIBBON_HYPER]   = { RIBBONGFX_CONTEST_HYPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_4)},
    [SMART_RIBBON_MASTER]  = { RIBBONGFX_CONTEST_MASTER, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_4)},
    [TOUGH_RIBBON_NORMAL]  = { RIBBONGFX_CONTEST_NORMAL, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_5)},
    [TOUGH_RIBBON_SUPER]   = { RIBBONGFX_CONTEST_SUPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_5)},
    [TOUGH_RIBBON_HYPER]   = { RIBBONGFX_CONTEST_HYPER,  TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_5)},
    [TOUGH_RIBBON_MASTER]  = { RIBBONGFX_CONTEST_MASTER, TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_5)},
    [WINNING_RIBBON]       = { RIBBONGFX_WINNING,        TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1)},
    [VICTORY_RIBBON]       = { RIBBONGFX_VICTORY,        TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1)},
    [ARTIST_RIBBON]        = { RIBBONGFX_ARTIST,         TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_2)},
    [EFFORT_RIBBON]        = { RIBBONGFX_EFFORT,         TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_3)},
    [MARINE_RIBBON]        = { RIBBONGFX_GIFT_1,         TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_2)},
    [LAND_RIBBON]          = { RIBBONGFX_GIFT_1,         TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_4)},
    [SKY_RIBBON]           = { RIBBONGFX_GIFT_1,         TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_5)},
    [COUNTRY_RIBBON]       = { RIBBONGFX_GIFT_2,         TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_4)},
    [NATIONAL_RIBBON]      = { RIBBONGFX_GIFT_2,         TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_5)},
    [EARTH_RIBBON]         = { RIBBONGFX_GIFT_3,         TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1)},
    [WORLD_RIBBON]         = { RIBBONGFX_GIFT_3,         TO_PAL_OFFSET(PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_2)},
};
...
{
    sRibbonIconsBig_Gfx, 0x1800, GFX_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_BIG
};

static const struct SpritePalette sSpritePalettes_RibbonIcons[] =
{
    {sRibbonIcons1_Pal, PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1},
    {sRibbonIcons2_Pal, PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_2},
    {sRibbonIcons3_Pal, PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_3},
    {sRibbonIcons4_Pal, PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_4},
    {sRibbonIcons5_Pal, PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_5},
    {},
};
...
{
    .tileTag = GFX_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_BIG,
    .paletteTag = PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1,
...
static void UpdateAndZoomInSelectedRibbon(struct Pokenav_RibbonsSummaryMenu *menu)
{
    ...
    menu->bigRibbonSprite->oam.tileNum = (sRibbonGfxData[ribbonId].tileNumOffset * 16) + GetSpriteTileStartByTag(GFX_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_BIG);
    menu->bigRibbonSprite->oam.paletteNum = IndexOfSpritePaletteTag(sRibbonGfxData[ribbonId].palNumOffset + PAL_TAG_POKENAV_RIBBONS_SUMMARY_RIBBON_ICONS_1);
