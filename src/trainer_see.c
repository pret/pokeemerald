...
// const rom data
static const u8 sEmotion_ExclamationMarkGfx[] = INCBIN_U8("build/assets/graphics/field_effects/pics/emotion_exclamation.4bpp");
static const u8 sEmotion_QuestionMarkGfx[] = INCBIN_U8("build/assets/graphics/field_effects/pics/emotion_question.4bpp");
static const u8 sEmotion_HeartGfx[] = INCBIN_U8("build/assets/graphics/field_effects/pics/emotion_heart.4bpp");
