    ...
    if (r10)
    {
            ...
            && gSprites[gBattlerSpriteIds[gActiveBattler]].callback == SpriteCallbackDummy)
        {
            ...
            if (IsDoubleBattle() && !(gBattleTypeFlags & BATTLE_TYPE_MULTI))
            {
                ...
                SetBattlerShadowSpriteCallback(BATTLE_PARTNER(gActiveBattler), GetMonData_2(&gEnemyParty[gBattlerPartyIndexes[BATTLE_PARTNER(gActiveBattler)]], MON_DATA_SPECIES));
            }
