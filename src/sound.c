...
// iwram bss
BSS_DATA static u16 sCurrentMapMusic;
BSS_DATA static u16 sNextMapMusic;
BSS_DATA static u8 sMapMusicState;
BSS_DATA static u8 sMapMusicFadeInSpeed;
BSS_DATA static u16 sFanfareCounter;
