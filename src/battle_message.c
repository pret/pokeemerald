...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PLAYERPICKEDUPMONEY - 12] = sText_PlayerPickedUpMoney, // The Player, not the Pokémon, picked up money (¥), not an item.
