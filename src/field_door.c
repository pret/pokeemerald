...
static const u8 sDoorAnimPalettes_PokeCenter[] = {0, 0, 0, 0};
static const u8 sDoorAnimPalettes_Gym[] = {0, 0, 0, 0};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_General_Door_PokeMart,                        DOOR_SOUND_SLIDING, 0, sDoorAnimTiles_PokeCenter, sDoorAnimPalettes_PokeCenter},
