...
static const u32 sMonFrame_Tilemap[] = INCBIN_U32("build/assets/graphics/pokeblock/use_screen/mon_frame.bin.lz");
static const u32 sGraphData_Tilemap[] = INCBIN_U32("build/assets/graphics/pokeblock/use_screen/graph_data.bin.lz");
