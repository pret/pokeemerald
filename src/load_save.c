...
// Uses the trainerId as part of a pseudo-random number generation.
void SetSaveBlocksPointers(u16 trainerId)
{
    struct SaveBlock1** sav1_LocalVar = &gSaveBlock1Ptr;

    u16 offset = (trainerId + Random()) & (SAVEBLOCK_MOVE_RANGE - 4);
