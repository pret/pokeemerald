...
const u16 gSpeciesToNationalPokedexNum[NUM_SPECIES] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
    ...
    // Megas
	[SPECIES_MEGA_VENUSAUR - 1] = NATIONAL_DEX_VENUSAUR,
	[SPECIES_MEGA_CHARIZARD_X - 1] = NATIONAL_DEX_CHARIZARD,
	[SPECIES_MEGA_CHARIZARD_Y - 1] = NATIONAL_DEX_CHARIZARD,
	[SPECIES_MEGA_BLASTOISE - 1] = NATIONAL_DEX_BLASTOISE,
	[SPECIES_MEGA_BEEDRILL - 1] = NATIONAL_DEX_BEEDRILL,
	[SPECIES_MEGA_PIDGEOT - 1] = NATIONAL_DEX_PIDGEOT,
	[SPECIES_MEGA_ALAKAZAM - 1] = NATIONAL_DEX_ALAKAZAM,
	[SPECIES_MEGA_SLOWBRO - 1] = NATIONAL_DEX_SLOWBRO,
	[SPECIES_MEGA_GENGAR - 1] = NATIONAL_DEX_GENGAR,
	[SPECIES_MEGA_KANGASKHAN - 1] = NATIONAL_DEX_KANGASKHAN,
	[SPECIES_MEGA_PINSIR - 1] = NATIONAL_DEX_PINSIR,
	[SPECIES_MEGA_GYARADOS - 1] = NATIONAL_DEX_GYARADOS,
	[SPECIES_MEGA_AERODACTYL - 1] = NATIONAL_DEX_AERODACTYL,
	[SPECIES_MEGA_MEWTWO_X - 1] = NATIONAL_DEX_MEWTWO,
	[SPECIES_MEGA_MEWTWO_Y - 1] = NATIONAL_DEX_MEWTWO,
	[SPECIES_MEGA_AMPHAROS - 1] = NATIONAL_DEX_AMPHAROS,
	[SPECIES_MEGA_STEELIX - 1] = NATIONAL_DEX_STEELIX,
	[SPECIES_MEGA_SCIZOR - 1] = NATIONAL_DEX_SCIZOR,
	[SPECIES_MEGA_HERACROSS - 1] = NATIONAL_DEX_HERACROSS,
	[SPECIES_MEGA_HOUNDOOM - 1] = NATIONAL_DEX_HOUNDOOM,
	[SPECIES_MEGA_TYRANITAR - 1] = NATIONAL_DEX_TYRANITAR,
	[SPECIES_MEGA_SCEPTILE - 1] = NATIONAL_DEX_SCEPTILE,
	[SPECIES_MEGA_BLAZIKEN - 1] = NATIONAL_DEX_BLAZIKEN,
	[SPECIES_MEGA_SWAMPERT - 1] = NATIONAL_DEX_SWAMPERT,
	[SPECIES_MEGA_GARDEVOIR - 1] = NATIONAL_DEX_GARDEVOIR,
	[SPECIES_MEGA_SABLEYE - 1] = NATIONAL_DEX_SABLEYE,
	[SPECIES_MEGA_MAWILE - 1] = NATIONAL_DEX_MAWILE,
	[SPECIES_MEGA_AGGRON - 1] = NATIONAL_DEX_AGGRON,
	[SPECIES_MEGA_MEDICHAM - 1] = NATIONAL_DEX_MEDICHAM,
	[SPECIES_MEGA_MANECTRIC - 1] = NATIONAL_DEX_MANECTRIC,
	[SPECIES_MEGA_SHARPEDO - 1] = NATIONAL_DEX_SHARPEDO,
	[SPECIES_MEGA_CAMERUPT - 1] = NATIONAL_DEX_CAMERUPT,
	[SPECIES_MEGA_ALTARIA - 1] = NATIONAL_DEX_ALTARIA,
	[SPECIES_MEGA_BANETTE - 1] = NATIONAL_DEX_BANETTE,
	[SPECIES_MEGA_ABSOL - 1] = NATIONAL_DEX_ABSOL,
	[SPECIES_MEGA_GLALIE - 1] = NATIONAL_DEX_GLALIE,
	[SPECIES_MEGA_SALAMENCE - 1] = NATIONAL_DEX_SALAMENCE,
	[SPECIES_MEGA_METAGROSS - 1] = NATIONAL_DEX_METAGROSS,
	[SPECIES_MEGA_LATIAS - 1] = NATIONAL_DEX_LATIAS,
	[SPECIES_MEGA_LATIOS - 1] = NATIONAL_DEX_LATIOS,
	[SPECIES_MEGA_LOPUNNY - 1] = NATIONAL_DEX_LOPUNNY,
	[SPECIES_MEGA_GARCHOMP - 1] = NATIONAL_DEX_GARCHOMP,
	[SPECIES_MEGA_LUCARIO - 1] = NATIONAL_DEX_LUCARIO,
	[SPECIES_MEGA_ABOMASNOW - 1] = NATIONAL_DEX_ABOMASNOW,
	[SPECIES_MEGA_GALLADE - 1] = NATIONAL_DEX_GALLADE,
	[SPECIES_MEGA_AUDINO - 1] = NATIONAL_DEX_AUDINO,
	[SPECIES_MEGA_DIANCIE - 1] = NATIONAL_DEX_DIANCIE,
    // Special Mega + Primals
	[SPECIES_MEGA_RAYQUAZA - 1] = NATIONAL_DEX_RAYQUAZA,
	[SPECIES_PRIMAL_KYOGRE - 1] = NATIONAL_DEX_KYOGRE,
	[SPECIES_PRIMAL_GROUDON - 1] = NATIONAL_DEX_GROUDON,
    // Alolan Forms
	...
	[SPECIES_VIVILLON_HIGH_PLAINS - 1] = NATIONAL_DEX_FURFROU,
	[SPECIES_VIVILLON_HIGH_PLAINS - 1] = NATIONAL_DEX_FURFROU,
    // Meowstic
