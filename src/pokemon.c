...
{
    {.x = 16, .y =  7, .image = INCBIN_U16("build/assets/graphics/pokemon/spinda/spots/spot_0.1bpp")},
    {.x = 40, .y =  8, .image = INCBIN_U16("build/assets/graphics/pokemon/spinda/spots/spot_1.1bpp")},
    {.x = 22, .y = 25, .image = INCBIN_U16("build/assets/graphics/pokemon/spinda/spots/spot_2.1bpp")},
    {.x = 34, .y = 26, .image = INCBIN_U16("build/assets/graphics/pokemon/spinda/spots/spot_3.1bpp")}
};
