...
const u16 gSpeciesToNationalPokedexNum[NUM_SPECIES] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
	...
	[SPECIES_BURMY_SANDY] = NATIONAL_DEX_BURMY,
	[SPECIES_BURMY_TRASH] = NATIONAL_DEX_BURMY,
	SPECIES_TO_NATIONAL(WORMADAM),
	[SPECIES_WORMADAM_SANDY] = NATIONAL_DEX_WORMADAM,
	[SPECIES_WORMADAM_TRASH] = NATIONAL_DEX_WORMADAM,
