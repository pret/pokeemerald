...
//Hisuian Forms
    ...
    // Gigantamax Forms
    [SPECIES_VENUSAUR_GMAX - 1] = NATIONAL_DEX_VENUSAUR,
    [SPECIES_CHARIZARD_GMAX - 1] = NATIONAL_DEX_CHARIZARD,
    [SPECIES_BLASTOISE_GMAX - 1] = NATIONAL_DEX_BLASTOISE,
    [SPECIES_BUTTERFREE_GMAX - 1] = NATIONAL_DEX_BUTTERFREE,
    [SPECIES_PIKACHU_GMAX - 1] = NATIONAL_DEX_PIKACHU,
    [SPECIES_MEOWTH_GMAX - 1] = NATIONAL_DEX_MEOWTH,
    [SPECIES_MACHAMP_GMAX - 1] = NATIONAL_DEX_MACHAMP,
    [SPECIES_GENGAR_GMAX - 1] = NATIONAL_DEX_GENGAR,
    [SPECIES_KINGLER_GMAX - 1] = NATIONAL_DEX_KINGLER,
    [SPECIES_LAPRAS_GMAX - 1] = NATIONAL_DEX_LAPRAS,
    [SPECIES_EEVEE_GMAX - 1] = NATIONAL_DEX_EEVEE,
    [SPECIES_SNORLAX_GMAX - 1] = NATIONAL_DEX_SNORLAX,
    [SPECIES_GARBODOR_GMAX - 1] = NATIONAL_DEX_GARBODOR,
    [SPECIES_MELMETAL_GMAX - 1] = NATIONAL_DEX_MELMETAL,
    [SPECIES_RILLABOOM_GMAX - 1] = NATIONAL_DEX_RILLABOOM,
    [SPECIES_CINDERACE_GMAX - 1] = NATIONAL_DEX_CINDERACE,
    [SPECIES_INTELEON_GMAX - 1] = NATIONAL_DEX_INTELEON,
    [SPECIES_CORVIKNIGHT_GMAX - 1] = NATIONAL_DEX_CORVIKNIGHT,
    [SPECIES_ORBEETLE_GMAX - 1] = NATIONAL_DEX_ORBEETLE,
    [SPECIES_DREDNAW_GMAX - 1] = NATIONAL_DEX_DREDNAW,
    [SPECIES_COALOSSAL_GMAX - 1] = NATIONAL_DEX_COALOSSAL,
    [SPECIES_FLAPPLE_GMAX - 1] = NATIONAL_DEX_FLAPPLE,
    [SPECIES_APPLETUN_GMAX - 1] = NATIONAL_DEX_APPLETUN,
    [SPECIES_SANDACONDA_GMAX - 1] = NATIONAL_DEX_SANDACONDA,
    [SPECIES_TOXTRICITY_GMAX - 1] = NATIONAL_DEX_TOXTRICITY,
    [SPECIES_CENTISKORCH_GMAX - 1] = NATIONAL_DEX_CENTISKORCH,
    [SPECIES_HATTERENE_GMAX - 1] = NATIONAL_DEX_HATTERENE,
    [SPECIES_GRIMMSNARL_GMAX - 1] = NATIONAL_DEX_GRIMMSNARL,
    [SPECIES_ALCREMIE_GMAX - 1] = NATIONAL_DEX_ALCREMIE,
    [SPECIES_COPPERAJAH_GMAX - 1] = NATIONAL_DEX_COPPERAJAH,
    [SPECIES_DURALUDON_GMAX - 1] = NATIONAL_DEX_DURALUDON,
    [SPECIES_URSHIFU_GMAX - 1] = NATIONAL_DEX_URSHIFU,
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE_GMAX - 1] = NATIONAL_DEX_URSHIFU,
#endif
};
