...
static mapsec_min16_t GetMapSecIdAt(u16 x, u16 y);
static void RegionMap_SetBG2XAndBG2Y(s16 x, s16 y);
static void InitMapBasedOnPlayerLocation(void);
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void);
static u8 GetMapsecType(mapsec_min16_t mapSecId);
static mapsec_min16_t CorrectSpecialMapSecId_Internal(mapsec_min16_t mapSecId);
static mapsec_min16_t GetTerraOrMarineCaveMapSecId(void);
static void GetMarineCaveCoords(u16 *x, u16 *y);
static bool32 IsPlayerInAquaHideout(mapsec_t mapSecId);
...
static const mapsec_min16_t sRegionMap_SpecialPlaceLocations[][2] =
{
...
static const mapsec_min16_t sMarineCaveMapSecIds[] =
{
    MAPSEC_MARINE_CAVE,
...
static const mapsec_min16_t sTerraOrMarineCaveMapSecIds[ABNORMAL_WEATHER_LOCATIONS] =
{
...
static const mapsec_t sMapSecAquaHideoutOld[] =
{
...
static const mapsec_t sMapSecIdsOffMap[] =
{
    MAPSEC_BIRTH_ISLAND,
...
static const mapsec_min16_t sRedOutlineFlyDestinations[][2] =
{
    {
...
mapsec_min16_t GetRegionMapSecIdAt(u16 x, u16 y)
{
...
mapsec_min16_t CorrectSpecialMapSecId(mapsec_min16_t mapSecId)
{
...
u8 *GetMapName(u8 *dest, mapsec_min16_t regionMapId, u16 padLength)
{
    u8 *str;
    u16 i;
...
u8 *GetMapNameGeneric(u8 *dest, mapsec_min16_t mapSecId)
{
    switch (mapSecId)
    {
    case MAPSEC_DYNAMIC:
...
u8 *GetMapNameHandleAquaHideout(u8 *dest, mapsec_min16_t mapSecId)
{
...
static void GetMapSecDimensions(mapsec_min16_t mapSecId, u16 *x, u16 *y, u16 *width, u16 *height)
{
...
bool32 IsEventIslandMapSecId(mapsec_t mapSecId)
{
    u32 i;
