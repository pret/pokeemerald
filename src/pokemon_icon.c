...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_VENUSAUR_MEGA] = gMonIcon_MegaVenusaur,
    [SPECIES_CHARIZARD_MEGA_X] = gMonIcon_MegaCharizardX,
    [SPECIES_CHARIZARD_MEGA_Y] = gMonIcon_MegaCharizardY,
    [SPECIES_BLASTOISE_MEGA] = gMonIcon_MegaBlastoise,
    [SPECIES_BEEDRILL_MEGA] = gMonIcon_MegaBeedrill,
    [SPECIES_PIDGEOT_MEGA] = gMonIcon_MegaPidgeot,
    [SPECIES_ALAKAZAM_MEGA] = gMonIcon_MegaAlakazam,
    [SPECIES_SLOWBRO_MEGA] = gMonIcon_MegaSlowbro,
    [SPECIES_GENGAR_MEGA] = gMonIcon_MegaGengar,
    [SPECIES_KANGASKHAN_MEGA] = gMonIcon_MegaKangaskhan,
    [SPECIES_PINSIR_MEGA] = gMonIcon_MegaPinsir,
    [SPECIES_GYARADOS_MEGA] = gMonIcon_MegaGyarados,
    [SPECIES_AERODACTYL_MEGA] = gMonIcon_MegaAerodactyl,
    [SPECIES_MEWTWO_MEGA_X] = gMonIcon_MegaMewtwoX,
    [SPECIES_MEWTWO_MEGA_Y] = gMonIcon_MegaMewtwoY,
    [SPECIES_AMPHAROS_MEGA] = gMonIcon_MegaAmpharos,
    [SPECIES_STEELIX_MEGA] = gMonIcon_MegaSteelix,
    [SPECIES_SCIZOR_MEGA] = gMonIcon_MegaScizor,
    [SPECIES_HERACROSS_MEGA] = gMonIcon_MegaHeracross,
    [SPECIES_HOUNDOOM_MEGA] = gMonIcon_MegaHoundoom,
    [SPECIES_TYRANITAR_MEGA] = gMonIcon_MegaTyranitar,
    [SPECIES_SCEPTILE_MEGA] = gMonIcon_MegaSceptile,
    [SPECIES_BLAZIKEN_MEGA] = gMonIcon_MegaBlaziken,
    [SPECIES_SWAMPERT_MEGA] = gMonIcon_MegaSwampert,
    [SPECIES_GARDEVOIR_MEGA] = gMonIcon_MegaGardevoir,
    [SPECIES_SABLEYE_MEGA] = gMonIcon_MegaSableye,
    [SPECIES_MAWILE_MEGA] = gMonIcon_MegaMawile,
    [SPECIES_AGGRON_MEGA] = gMonIcon_MegaAggron,
    [SPECIES_MEDICHAM_MEGA] = gMonIcon_MegaMedicham,
    [SPECIES_MANECTRIC_MEGA] = gMonIcon_MegaManectric,
    [SPECIES_SHARPEDO_MEGA] = gMonIcon_MegaSharpedo,
    [SPECIES_CAMERUPT_MEGA] = gMonIcon_MegaCamerupt,
    [SPECIES_ALTARIA_MEGA] = gMonIcon_MegaAltaria,
    [SPECIES_BANETTE_MEGA] = gMonIcon_MegaBanette,
    [SPECIES_ABSOL_MEGA] = gMonIcon_MegaAbsol,
    [SPECIES_GLALIE_MEGA] = gMonIcon_MegaGlalie,
    [SPECIES_SALAMENCE_MEGA] = gMonIcon_MegaSalamence,
    [SPECIES_METAGROSS_MEGA] = gMonIcon_MegaMetagross,
    [SPECIES_LATIAS_MEGA] = gMonIcon_MegaLatias,
    [SPECIES_LATIOS_MEGA] = gMonIcon_MegaLatios,
    [SPECIES_LOPUNNY_MEGA] = gMonIcon_MegaLopunny,
    [SPECIES_GARCHOMP_MEGA] = gMonIcon_MegaGarchomp,
    [SPECIES_LUCARIO_MEGA] = gMonIcon_MegaLucario,
    [SPECIES_ABOMASNOW_MEGA] = gMonIcon_MegaAbomasnow,
    [SPECIES_GALLADE_MEGA] = gMonIcon_MegaGallade,
    [SPECIES_AUDINO_MEGA] = gMonIcon_MegaAudino,
    [SPECIES_DIANCIE_MEGA] = gMonIcon_MegaDiancie,
    [SPECIES_RAYQUAZA_MEGA] = gMonIcon_MegaRayquaza,
    [SPECIES_KYOGRE_PRIMAL] = gMonIcon_PrimalKyogre,
    [SPECIES_GROUDON_PRIMAL] = gMonIcon_PrimalGroudon,
