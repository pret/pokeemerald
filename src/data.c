...
const u16 gMinigameDigits_Pal[] = INCBIN_U16("build/assets/graphics/link/minigame_digits.gbapal");
const u32 gMinigameDigits_Gfx[] = INCBIN_U32("build/assets/graphics/link/minigame_digits.4bpp.lz");
static const u32 sMinigameDigitsThin_Gfx[] = INCBIN_U32("build/assets/graphics/link/minigame_digits2.4bpp.lz"); // Unused
