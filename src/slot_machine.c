...
struct SlotMachine
{
    ...
    /*0x44*/ u8 flashMatchLineSpriteIds[NUM_MATCH_ROWS];
...
static bool8 IfTag7_SwitchColor(u8 *tagPtr)
{
    if (*tagPtr == GFXTAG_7_RED)
    {
        *tagPtr = GFXTAG_7_BLUE;
        return TRUE;
    }
    if (*tagPtr == GFXTAG_7_BLUE)
    {
        *tagPtr = GFXTAG_7_RED;
        return TRUE;
    }
