...
static const u16 sListArrow_Pal[] = INCBIN_U16("build/assets/graphics/pokenav/list_arrows.gbapal");
static const u32 sListArrow_Gfx[] = INCBIN_U32("build/assets/graphics/pokenav/list_arrows.4bpp.lz");
