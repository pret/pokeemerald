...
static const u8 sCaughtBall_Gfx[] = INCBIN_U8("build/assets/graphics/pokedex/caught_ball.4bpp");
...
static const u16 sSizeScreenSilhouette_Pal[] = INCBIN_U16("build/assets/graphics/pokedex/size_silhouette.gbapal");
