...
enum
{
    ...
    MENUITEM_MAIN_RANDOM_MAPS,
    MENUITEM_MAIN_RANDOM_MUSIC,
...
} static const sItemFunctionsMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_RANDOM_MAPS]  = {DrawChoices_RandomMaps,  ProcessInput_Options_Two},
    [MENUITEM_MAIN_RANDOM_MUSIC] = {DrawChoices_RandomMusic,  ProcessInput_Options_Two},
...
static const u8 *const sOptionsMenuItemsNamesMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_RANDOM_MAPS] = sText_RandomMaps,
    [MENUITEM_MAIN_RANDOM_MUSIC] = sText_RandomMusic,
...
static bool8 CheckConditions(int selection)
{
    switch(selection)
    {
        ...
        case MENUITEM_MAIN_RANDOM_MAPS:     return TRUE;
        case MENUITEM_MAIN_RANDOM_MUSIC:    return TRUE;
...
static const u8 *const sOptionsMenuItemDescriptionsMain[MENUITEM_MAIN_COUNT][3] =
{
    ...
    [MENUITEM_MAIN_RANDOM_MAPS] = {sText_Desc_RandomMaps_On,        sText_Desc_RandomMaps_Off,  sText_Empty},
    [MENUITEM_MAIN_RANDOM_MUSIC] = {sText_Desc_RandomMusic_Off,      sText_Desc_RandomMusic_On, sText_Empty},
...
void CB2_InitOptionsMenu(void)
{
    ...
    case 6:
        ...
        sOptions->sel[MENUITEM_MAIN_RANDOM_MAPS] = gSaveBlock2Ptr->optionsRandomMaps;
        sOptions->sel[MENUITEM_MAIN_RANDOM_MUSIC] = gSaveBlock2Ptr->optionsRandomMusic;
...
static void Task_OptionsMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsRandomMaps       = sOptions->sel[MENUITEM_MAIN_RANDOM_MAPS];
    gSaveBlock2Ptr->optionsRandomMusic      = sOptions->sel[MENUITEM_MAIN_RANDOM_MUSIC];
    ...
    if (sOptions->sel[MENUITEM_MAIN_RANDOM_MAPS] == 0)
...
static void DrawChoices_RandomMaps(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_RANDOM_MAPS);
    u8 styles[2] = {0};
    styles[selection] = 1;
...
static void DrawChoices_RandomMusic(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_RANDOM_MUSIC);
    u8 styles[2] = {0};
    styles[selection] = 1;
