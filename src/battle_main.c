...
const u16 sEncounterFlags[NUM_MAPSEC] = {
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DEWFORD_TOWN,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_PACIFIDLOG_TOWN,
    FLAG_ENCOUNTER_PETALBURG_CITY,
    FLAG_ENCOUNTER_SLATEPORT_CITY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_LILYCOVE_CITY,
    FLAG_ENCOUNTER_MOSSDEEP_CITY,
    FLAG_ENCOUNTER_SOOTOPOLIS_CITY,
    FLAG_ENCOUNTER_EVER_GRANDE_CITY,
    FLAG_ENCOUNTER_ROUTE_101,
    FLAG_ENCOUNTER_ROUTE_102,
    FLAG_ENCOUNTER_ROUTE_103,
    FLAG_ENCOUNTER_ROUTE_104,
    FLAG_ENCOUNTER_ROUTE_105,
    FLAG_ENCOUNTER_ROUTE_106,
    FLAG_ENCOUNTER_ROUTE_107,
    FLAG_ENCOUNTER_ROUTE_108,
    FLAG_ENCOUNTER_ROUTE_109,
    FLAG_ENCOUNTER_ROUTE_110,
    FLAG_ENCOUNTER_ROUTE_111,
    FLAG_ENCOUNTER_ROUTE_112,
    FLAG_ENCOUNTER_ROUTE_113,
    FLAG_ENCOUNTER_ROUTE_114,
    FLAG_ENCOUNTER_ROUTE_115,
    FLAG_ENCOUNTER_ROUTE_116,
    FLAG_ENCOUNTER_ROUTE_117,
    FLAG_ENCOUNTER_ROUTE_118,
    FLAG_ENCOUNTER_ROUTE_119,
    FLAG_ENCOUNTER_ROUTE_120,
    FLAG_ENCOUNTER_ROUTE_121,
    FLAG_ENCOUNTER_ROUTE_122,
    FLAG_ENCOUNTER_ROUTE_123,
    FLAG_ENCOUNTER_ROUTE_124,
    FLAG_ENCOUNTER_ROUTE_125,
    FLAG_ENCOUNTER_ROUTE_126,
    FLAG_ENCOUNTER_ROUTE_127,
    FLAG_ENCOUNTER_ROUTE_128,
    FLAG_ENCOUNTER_ROUTE_129,
    FLAG_ENCOUNTER_ROUTE_130,
    FLAG_ENCOUNTER_ROUTE_131,
    FLAG_ENCOUNTER_ROUTE_132,
    FLAG_ENCOUNTER_ROUTE_133,
    FLAG_ENCOUNTER_ROUTE_134,
    FLAG_ENCOUNTER_ROUTE_124,
    FLAG_ENCOUNTER_ROUTE_126,
    FLAG_ENCOUNTER_ROUTE_127,
    FLAG_ENCOUNTER_ROUTE_128,
    FLAG_ENCOUNTER_SOOTOPOLIS_CITY,
    FLAG_ENCOUNTER_GRANITE_CAVE,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_SAFARI_ZONE,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_PETALBURG_WOODS,
    FLAG_ENCOUNTER_RUSTURF_TUNNEL,
    FLAG_ENCOUNTER_ABANDONED_SHIP,
    FLAG_ENCOUNTER_NEW_MAUVILLE,
    FLAG_ENCOUNTER_METEOR_FALLS,
    FLAG_ENCOUNTER_METEOR_FALLS,
    FLAG_ENCOUNTER_MT_PYRE,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_SHOAL_CAVE,
    FLAG_ENCOUNTER_SEAFLOOR_CAVERN,
    FLAG_ENCOUNTER_SEAFLOOR_CAVERN,
    FLAG_ENCOUNTER_VICTORY_ROAD,
    FLAG_ENCOUNTER_MIRAGE_ISLAND,
    FLAG_ENCOUNTER_CAVE_OF_ORIGIN,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_FIERY_PATH,
    FLAG_ENCOUNTER_FIERY_PATH,
    FLAG_ENCOUNTER_JAGGED_PASS,
    FLAG_ENCOUNTER_JAGGED_PASS,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    ...
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_AQUA_HIDEOUT,
    FLAG_ENCOUNTER_MAGMA_HIDEOUT,
    FLAG_ENCOUNTER_MIRAGE_TOWER,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_ARTISAN_CAVE,
    FLAG_ENCOUNTER_MARINE_CAVE,
    FLAG_ENCOUNTER_MARINE_CAVE,
    FLAG_ENCOUNTER_TERRA_CAVE,
    FLAG_ENCOUNTER_ROUTE_105,
    FLAG_ENCOUNTER_ROUTE_125,
    FLAG_ENCOUNTER_ROUTE_129,
    FLAG_ENCOUNTER_DESERT_UNDERPASS,
    FLAG_ENCOUNTER_ALTERING_CAVE,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
    FLAG_ENCOUNTER_DUMMY,
};
