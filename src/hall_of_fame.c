...
static const u16 sHallOfFame_Pal[] = INCBIN_U16("build/assets/graphics/misc/japanese_hof.gbapal");

static const u32 sHallOfFame_Gfx[] = INCBIN_U32("build/assets/graphics/misc/japanese_hof.4bpp.lz");
