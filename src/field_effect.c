...
bool8 FldEff_FieldMoveShowMonInit(void)
{
    ...
    gFieldEffectArguments[0] = GetMonData_2(pokemon, MON_DATA_SPECIES);
    gFieldEffectArguments[1] = GetMonData_2(pokemon, MON_DATA_OT_ID);
    gFieldEffectArguments[2] = GetMonData_2(pokemon, MON_DATA_PERSONALITY);
