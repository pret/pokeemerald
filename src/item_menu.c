...
static void BagMenu_ItemPrintCallback(u8 windowId, u32 itemIndex, u8 y)
{
    ...
    if (itemIndex != LIST_CANCEL)
    {
        ...
        if (gBagPosition.pocket == BERRIES_POCKET)
        {
            ...
            offset = GetStringRightAlignXOffset(FONT_NARROW, gStringVarBuffer, 119);
            BagMenu_Print(windowId, FONT_NARROW, gStringVarBuffer, offset, y, 0, 0, TEXT_SKIP_DRAW, COLORID_NORMAL);
        }
...
static void PrintItemQuantity(u8 windowId, s16 quantity)
{
    ...
    StringExpandPlaceholders(gStringVarBuffer, gText_xVar1);
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gStringVarBuffer, GetStringCenterAlignXOffset(FONT_NORMAL, gStringVarBuffer, 0x28), 2, 0, 0);
}
...
static void PrintItemSoldAmount(int windowId, int numSold, int moneyEarned)
{
    ...
    StringExpandPlaceholders(gStringVarBuffer, gText_xVar1);
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gStringVarBuffer, 0, 1, TEXT_SKIP_DRAW, 0);
...
static void StartItemSwap(u8 taskId)
{
    ...
    FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
    BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringVarBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
...
static void PrintItemCantBeHeld(u8 taskId)
{
    ...
    DisplayItemMessage(taskId, FONT_NORMAL, gStringVarBuffer, HandleErrorMessage);
}
...
static void Task_ItemContext_Sell(u8 taskId)
{
    ...
    if (ItemId_GetPrice(gSpecialVar_ItemId) == 0)
    {
        ...
        StringExpandPlaceholders(gStringVarBuffer, gText_CantBuyKeyItem);
    ...
    else
    {
        ...
        {
            CopyItemName(gSpecialVar_ItemId, gStringVar2);
            StringExpandPlaceholders(gStringVarBuffer, gText_HowManyToSell);
            DisplayItemMessage(taskId, FONT_NORMAL, gStringVarBuffer, InitSellHowManyInput);
        }
    }
}
...
static void DisplaySellItemPriceAndConfirm(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringVarBuffer, gText_ICanPayVar1);
    DisplayItemMessage(taskId, FONT_NORMAL, gStringVarBuffer, AskSellItems);
}
...
static void ConfirmSell(u8 taskId)
{
    ...
    CopyItemName(gSpecialVar_ItemId, gStringVar2);
    ConvertIntToDecimalStringN(gStringVar1, (ItemId_GetPrice(gSpecialVar_ItemId) / 2) * tItemCount, STR_CONV_MODE_LEFT_ALIGN, 6);
    StringExpandPlaceholders(gStringVarBuffer, gText_TurnedOverVar1ForVar2);
    DisplayItemMessage(taskId, FONT_NORMAL, gStringVarBuffer, SellItem);
}
...
static void Task_ItemContext_Deposit(u8 taskId)
{
    ...
    {
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        StringExpandPlaceholders(gStringVarBuffer, gText_DepositHowManyVar1);
        FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringVarBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
        AddItemQuantityWindow(ITEMWIN_QUANTITY);
...
static void TryDepositItem(u8 taskId)
{
    ...
    else if (AddPCItem(gSpecialVar_ItemId, tItemCount) == TRUE)
    {
        ...
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        ConvertIntToDecimalStringN(gStringVar2, tItemCount, STR_CONV_MODE_LEFT_ALIGN, MAX_ITEM_DIGITS);
        StringExpandPlaceholders(gStringVarBuffer, gText_DepositedVar2Var1s);
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringVarBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
        gTasks[taskId].func = Task_RemoveItemFromBag;
    }
    else
