...
extern const u32 gMonFrontPic_Crewmate[];
extern const u32 gMonPalette_Crewmate[];
extern const u32 gMonBackPic_Crewmate[];
extern const u32 gMonShinyPalette_Crewmate[];
extern const u32 gMonStillFrontPic_Crewmate[];
extern const u8 gMonIcon_Crewmate[];
extern const u8 gMonFootprint_Crewmate[];
extern const u32 gMonFrontPic_Fren[];
extern const u32 gMonPalette_Fren[];
extern const u32 gMonBackPic_Fren[];
extern const u32 gMonShinyPalette_Fren[];
extern const u32 gMonStillFrontPic_Fren[];
extern const u8 gMonIcon_Fren[];
extern const u8 gMonFootprint_Fren[];
extern const u32 gMonFrontPic_Dumpy[];
extern const u32 gMonPalette_Dumpy[];
extern const u32 gMonBackPic_Dumpy[];
extern const u32 gMonShinyPalette_Dumpy[];
extern const u32 gMonStillFrontPic_Dumpy[];
extern const u8 gMonIcon_Dumpy[];
extern const u8 gMonFootprint_Dumpy[];
