...
extern const u8 gText_PartyMenu_ChoosePkmnOrCancel[];
extern const u8 gText_PartyMenu_ChoosePkmnConfirm[];
extern const u8 gText_PartyMenu_MovePkmnPrompt[];
extern const u8 gText_PartyMenu_TeachMovePrompt[];
extern const u8 gText_PartyMenu_UseItemPrompt[];
extern const u8 gText_PartyMenu_GiveItemPrompt[];
extern const u8 gText_PartyMenu_CantCut[];
extern const u8 gText_PartyMenu_CantSurf[];
extern const u8 gText_PartyMenu_AlreadySurfing[];
extern const u8 gText_PartyMenu_SurfDisallowed[];
extern const u8 gText_PartyMenu_CantBecauseCycling[];
extern const u8 gText_PartyMenu_AlreadyUsing[];
extern const u8 gText_PartyMenu_CantUse[];
extern const u8 gText_PartyMenu_NoQualifiedPkmn[];
extern const u8 gText_PartyMenu_ChoosePkmn2[];
extern const u8 gText_PartyMenu_NotEnoughHP[];
extern const u8 gText_PartyMenu_NumPkmnNeeded[];
extern const u8 gText_PartyMenu_SpeciesClauseError[];
extern const u8 gText_PartyMenu_ItemClauseError[];
extern const u8 gText_PartyMenu_DoWhatPrompt[];
extern const u8 gText_PartyMenu_RestorePPPrompt[];
extern const u8 gText_PartyMenu_BoostPPPrompt[];
...
extern const u8 gText_PartyMenu_Entered2[];
extern const u8 gText_PartyMenu_Entered3[];
extern const u8 gText_PartyMenu_Entered4[];
extern const u8 gText_PartyMenu_Able[];
extern const u8 gText_PartyMenu_NotAble[];
extern const u8 gText_PartyMenu_AbleBang[];
extern const u8 gText_PartyMenu_NotAbleBang[];
extern const u8 gText_PartyMenu_Learned[];
extern const u8 gText_PartyMenu_Have[];
extern const u8 gText_PartyMenu_DontHave[];
