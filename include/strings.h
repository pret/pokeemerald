...
extern const u8 gText_StatEdit[];
extern const u8 gText_StatView[];
...
extern const u8 gText_RachelApproach[];
extern const u8 gText_ConnorApproach[];
extern const u8 gText_SarahApproach[];
extern const u8 gText_MaxApproach[];
extern const u8 gText_IsabellaApproach[];
extern const u8 gText_LeonApproach[];
extern const u8 gText_EvaApproach[];
extern const u8 gText_JasonApproach[];
extern const u8 gText_MeganApproach[];
extern const u8 gText_SamApproach[];
extern const u8 gText_KateApproach[];
extern const u8 gText_LukeApproach[];
extern const u8 gText_MiaApproach[];
extern const u8 gText_JackApproach[];
extern const u8 gText_AnnaApproach[];
extern const u8 gText_DylanApproach[];
extern const u8 gText_LilyApproach[];
extern const u8 gText_CalebApproach[];
extern const u8 gText_EllaApproach[];
extern const u8 gText_BenApproach[];
extern const u8 gText_SophiaApproach[];
extern const u8 gText_MasonApproach[];
extern const u8 gText_ChloeApproach[];
extern const u8 gText_GraysonApproach[];
extern const u8 gText_AmeliaApproach[];
extern const u8 gText_OwenApproach[];
extern const u8 gText_GraceApproach[];
extern const u8 gText_LoganApproach[];
extern const u8 gText_VictoriaApproach[];
extern const u8 gText_CooperApproach[];
extern const u8 gText_RubyApproach[];
extern const u8 gText_ColeApproach[];
extern const u8 gText_AubreyApproach[];
extern const u8 gText_RyderApproach[];
extern const u8 gText_CamilaApproach[];
extern const u8 gText_AsherApproach[];
extern const u8 gText_AriaApproach[];
extern const u8 gText_HudsonApproach[];
extern const u8 gText_LaurenApproach[];
extern const u8 gText_GavinApproach[];
extern const u8 gText_BellaApproach[];
extern const u8 gText_LeoApproach[];
extern const u8 gText_NatalieApproach[];
extern const u8 gText_JaxonApproach[];
extern const u8 gText_VioletApproach[];
extern const u8 gText_AidenApproach[];
extern const u8 gText_SophieApproach[];
extern const u8 gText_EthanApproach[];
extern const u8 gText_CharlotteApproach[];
extern const u8 gText_AubreeApproach[];
extern const u8 gText_TannerApproach[];
extern const u8 gText_PeytonApproach[];
extern const u8 gText_AndrewApproach[];
extern const u8 gText_LaylaApproach[];
extern const u8 gText_SawyerApproach[];
extern const u8 gText_ZoeApproach[];
extern const u8 gText_NathanApproach[];
extern const u8 gText_EmilyApproach[];
extern const u8 gText_LiamApproach[];
extern const u8 gText_EvelynApproach[];
extern const u8 gText_WilliamApproach[];
extern const u8 gText_CoraApproach[];
extern const u8 gText_JoshuaApproach[];
extern const u8 gText_MadelynApproach[];
extern const u8 gText_BrandonApproach[];
extern const u8 gText_MayaApproach[];
extern const u8 gText_AveryApproach[];
extern const u8 gText_LeahApproach[];
extern const u8 gText_BradenApproach[];
extern const u8 gText_NoraApproach[];
extern const u8 gText_HunterApproach[];
...
extern const u8 gText_RachelDefeat[];
extern const u8 gText_SarahDefeat[];
extern const u8 gText_MaxDefeat[];
extern const u8 gText_IsabellaDefeat[];
extern const u8 gText_LeonDefeat[];
extern const u8 gText_EvaDefeat[];
extern const u8 gText_JasonDefeat[];
extern const u8 gText_MeganDefeat[];
extern const u8 gText_SamDefeat[];
extern const u8 gText_KateDefeat[];
extern const u8 gText_LukeDefeat[];
extern const u8 gText_MiaDefeat[];
extern const u8 gText_JackDefeat[];
extern const u8 gText_AnnaDefeat[];
extern const u8 gText_DylanDefeat[];
extern const u8 gText_LilyDefeat[];
extern const u8 gText_CalebDefeat[];
extern const u8 gText_EllaDefeat[];
extern const u8 gText_BenDefeat[];
extern const u8 gText_SophiaDefeat[];
extern const u8 gText_MasonDefeat[];
extern const u8 gText_ChloeDefeat[];
extern const u8 gText_GraysonDefeat[];
extern const u8 gText_AmeliaDefeat[];
extern const u8 gText_OwenDefeat[];
extern const u8 gText_GraceDefeat[];
extern const u8 gText_LoganDefeat[];
extern const u8 gText_VictoriaDefeat[];
extern const u8 gText_CooperDefeat[];
extern const u8 gText_RubyDefeat[];
extern const u8 gText_ColeDefeat[];
extern const u8 gText_AubreyDefeat[];
extern const u8 gText_RyderDefeat[];
extern const u8 gText_CamilaDefeat[];
extern const u8 gText_AsherDefeat[];
extern const u8 gText_AriaDefeat[];
extern const u8 gText_HudsonDefeat[];
extern const u8 gText_LaurenDefeat[];
extern const u8 gText_GavinDefeat[];
extern const u8 gText_BellaDefeat[];
extern const u8 gText_LeoDefeat[];
extern const u8 gText_NatalieDefeat[];
extern const u8 gText_JaxonDefeat[];
extern const u8 gText_VioletDefeat[];
extern const u8 gText_AidenDefeat[];
extern const u8 gText_SophieDefeat[];
extern const u8 gText_EthanDefeat[];
extern const u8 gText_CharlotteDefeat[];
extern const u8 gText_ConnorDefeat[];
extern const u8 gText_AubreeDefeat[];
extern const u8 gText_TannerDefeat[];
extern const u8 gText_PeytonDefeat[];
extern const u8 gText_AndrewDefeat[];
extern const u8 gText_LaylaDefeat[];
extern const u8 gText_SawyerDefeat[];
extern const u8 gText_ZoeDefeat[];
extern const u8 gText_NathanDefeat[];
extern const u8 gText_EmilyDefeat[];
extern const u8 gText_LiamDefeat[];
extern const u8 gText_EvelynDefeat[];
extern const u8 gText_WilliamDefeat[];
extern const u8 gText_CoraDefeat[];
extern const u8 gText_JoshuaDefeat[];
extern const u8 gText_MadelynDefeat[];
extern const u8 gText_BrandonDefeat[];
extern const u8 gText_MayaDefeat[];
extern const u8 gText_AveryDefeat[];
extern const u8 gText_LeahDefeat[];
extern const u8 gText_BradenDefeat[];
extern const u8 gText_NoraDefeat[];
extern const u8 gText_HunterDefeat[];
extern const u8 gText_AinsleyDefeat[];
extern const u8 gText_GriffinDefeat[];
