...
#define IS_BATTLER_OF_TYPE(battlerId, type)((gBattleMons[battlerId].types[TYPE_PRIMARY] == type || gBattleMons[battlerId].types[TYPE_SECONDARY] == type))
#define SET_BATTLER_TYPE(battlerId, type)   \
{                                           \
    gBattleMons[battlerId].types[TYPE_PRIMARY] = type;    \
    gBattleMons[battlerId].types[TYPE_SECONDARY] = type;    \
}
