...
extern u8 gBattleBufferA[MAX_BATTLERS_COUNT_2][0x200];
extern u8 gBattleBufferB[MAX_BATTLERS_COUNT_2][0x200];
extern u8 gActiveBattler;
extern u32 gBattleControllerExecFlags;
extern u8 gBattlersCount;
extern u16 gBattlerPartyIndexes[MAX_BATTLERS_COUNT_2];
extern u8 gBattlerPositions[MAX_BATTLERS_COUNT_2];
extern u8 gActionsByTurnOrder[MAX_BATTLERS_COUNT_2];
extern u8 gBattlerByTurnOrder[MAX_BATTLERS_COUNT_2];
extern u8 gCurrentTurnActionNumber;
extern u8 gCurrentActionFuncId;
extern struct BattlePokemon gBattleMons[MAX_BATTLERS_COUNT_2];
extern u8 gBattlerSpriteIds[MAX_BATTLERS_COUNT_2];
...
extern s32 gHpDealt;
extern s32 gTakenDmg[MAX_BATTLERS_COUNT_2];
...
extern u8 gChosenActionByBattler[MAX_BATTLERS_COUNT_2];
extern const u8 *gSelectionBattleScripts[MAX_BATTLERS_COUNT_2];
extern const u8 *gPalaceSelectionBattleScripts[MAX_BATTLERS_COUNT_2];
extern u16 gLastPrintedMoves[MAX_BATTLERS_COUNT_2];
extern u16 gLastMoves[MAX_BATTLERS_COUNT_2];
extern u16 gLastLandedMoves[MAX_BATTLERS_COUNT_2];
extern u16 gLastHitByType[MAX_BATTLERS_COUNT_2];
extern u16 gLastResultingMoves[MAX_BATTLERS_COUNT_2];
extern u16 gLockedMoves[MAX_BATTLERS_COUNT_2];
extern u8 gLastHitBy[MAX_BATTLERS_COUNT_2];
extern u16 gChosenMoveByBattler[MAX_BATTLERS_COUNT_2];
extern u8 gMoveResultFlags;
extern u32 gHitMarker;
extern u8 gTakenDmgByBattler[MAX_BATTLERS_COUNT_2];
extern u8 gUnusedFirstBattleVar2;
extern u16 gSideStatuses[2];
extern struct SideTimer gSideTimers[2];
extern u32 gStatuses3[MAX_BATTLERS_COUNT_2];
extern struct DisableStruct gDisableStructs[MAX_BATTLERS_COUNT_2];
extern u16 gPauseCounterBattle;
extern u16 gPaydayMoney;
extern u16 gRandomTurnNumber;
extern u8 gBattleCommunication[BATTLE_COMMUNICATION_ENTRIES_COUNT];
extern u8 gBattleOutcome;
extern struct ProtectStruct gProtectStructs[MAX_BATTLERS_COUNT_2];
extern struct SpecialStatus gSpecialStatuses[MAX_BATTLERS_COUNT_2];
...
extern struct BattleEnigmaBerry gEnigmaBerries[MAX_BATTLERS_COUNT_2];
