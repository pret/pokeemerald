...
enum {
    ...
    FANFARE_HG_PARTNER,
    FANFARE_BW_OBTAIN_KEY_ITEM,
    FANFARE_BW_LEVEL_UP,
    FANFARE_BW_HEAL,
    FANFARE_BW_DEX_RATING_1,
    FANFARE_BW_DEX_RATING_2,
    FANFARE_BW_DEX_RATING_3,
    FANFARE_BW_DEX_RATING_4,
    FANFARE_BW_DEX_RATING_5,
    FANFARE_BW_DEX_RATING_6,
    FANFARE_BW_XTRANSCEIVER,
    FANFARE_BW_OBTAIN_ITEM,
    FANFARE_BW_EVOLVED,
    FANFARE_BW_OBTAIN_BADGE,
    FANFARE_BW_OBTAIN_TMHM,
    FANFARE_BW_MOVE_DELETED,
    FANFARE_BW_LIGHT_DARK_STONE,
    FANFARE_BW_RECEIVE_EGG,
    FANFARE_BW_OBTAIN_B_POINTS,
    FANFARE_BW_ACCESSORY,
    FANFARE_BW_FEELING_CHECK_START,
    FANFARE_BW_FEELING_CHECK_3,
    FANFARE_BW_FEELING_CHECK_2,
    FANFARE_BW_FEELING_CHECK_1,
    FANFARE_BW_MISSION_START,
    FANFARE_BW_MISSION_CLEAR,
    FANFARE_BW_MISSION_FAILED,
