...
#define MOVEMENT_ACTION_FOLLOWING_POKEMON               0x9E
#define MOVEMENT_ACTION_FOLLOWING_POKEMON_FACESOUTH     0x9F
#define MOVEMENT_ACTION_FOLLOWING_POKEMON_FACENORTH     0xA0
#define MOVEMENT_ACTION_FOLLOWING_POKEMON_FACEWEST      0xA1
#define MOVEMENT_ACTION_FOLLOWING_POKEMON_FACEEAST      0xA2
#define MOVEMENT_ACTION_FOLLOWING_POKEMON_WALKSOUTH     0xA3
#define MOVEMENT_ACTION_FOLLOWING_POKEMON_SHRINK        0xA4
#define MOVEMENT_ACTION_FOLLOWING_POKEMON_GROW          0xA5
