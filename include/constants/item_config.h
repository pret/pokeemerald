...
#define I_SOUL_DEW_BOOST        GEN_7   // In Gens3-6, Soul Dew boosts the stats of Lati@s by 50%. In Gen7+ it boosts the power of their Psychic and Dragon type moves by 20% instead.
