...
override CFLAGS += -mthumb -mthumb-interwork -O2 -mabi=apcs-gnu -mcpu=arm7tdmi -masm-syntax-unified -fno-toplevel-reorder -Wno-pointer-to-int-cast
...
$(C_BUILDDIR)/librfu_intr.o: CFLAGS := -mthumb-interwork -O2 -mabi=apcs-gnu -mcpu=arm7tdmi -masm-syntax-unified -fno-toplevel-reorder -Wno-pointer-to-int-cast
endif
