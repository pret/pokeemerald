...
ifeq ($(MODERN),0)
  ...
  override CFLAGS += -mthumb-interwork -Wimplicit -Wparentheses -O$(O_LEVEL) -fhex-asm -g
  ...
  override CFLAGS += -mthumb -mthumb-interwork -O$(O_LEVEL) -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast -std=gnu17 -Wall -Wno-strict-aliasing -Wno-attribute-alias -Woverride-init -Wno-unused-function -Wno-unused-variable -Wno-unused-but-set-variable -Wno-missing-braces
  ifeq ($(ANALYZE),1)
